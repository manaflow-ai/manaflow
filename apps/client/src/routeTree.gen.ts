...
import { Route as LayoutTeamSlugOrIdOnboardingRouteImport } from './routes/_layout.$teamSlugOrId.onboarding'
...
const LayoutTeamSlugOrIdOnboardingRoute =
  LayoutTeamSlugOrIdOnboardingRouteImport.update({
    id: '/onboarding',
    path: '/onboarding',
    getParentRoute: () => LayoutTeamSlugOrIdRoute,
  } as any)
...
export interface FileRoutesByFullPath {
  ...
  '/$teamSlugOrId/onboarding': typeof LayoutTeamSlugOrIdOnboardingRoute
...
export interface FileRoutesById {
  ...
  '/_layout/$teamSlugOrId/onboarding': typeof LayoutTeamSlugOrIdOnboardingRoute
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_layout/$teamSlugOrId/onboarding'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/$teamSlugOrId/onboarding': {
      id: '/_layout/$teamSlugOrId/onboarding'
      path: '/onboarding'
      fullPath: '/$teamSlugOrId/onboarding'
      preLoaderRoute: typeof LayoutTeamSlugOrIdOnboardingRouteImport
      parentRoute: typeof LayoutTeamSlugOrIdRoute
    }
    '/_layout/$teamSlugOrId/logs': {
...
interface LayoutTeamSlugOrIdRouteChildren {
  ...
  LayoutTeamSlugOrIdOnboardingRoute: typeof LayoutTeamSlugOrIdOnboardingRoute
...
const LayoutTeamSlugOrIdRouteChildren: LayoutTeamSlugOrIdRouteChildren = {
  ...
  LayoutTeamSlugOrIdOnboardingRoute: LayoutTeamSlugOrIdOnboardingRoute,
