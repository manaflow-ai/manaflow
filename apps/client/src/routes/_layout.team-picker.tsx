...
function TeamPicker() {
  ...
  return (
    <div className="min-h-dvh w-full flex items-center justify-center p-6 bg-gradient-to-br from-red-400 via-purple-400 to-blue-400 dark:from-red-600 dark:via-purple-600 dark:to-blue-600">
      {isElectron ? (
        <div
