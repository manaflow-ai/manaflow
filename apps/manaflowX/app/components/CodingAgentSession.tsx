  ...
  return (
    <div className="h-full flex flex-col bg-black">
      ...
      <div className="flex-shrink-0 p-4 border-b border-gray-800 bg-black/80 backdrop-blur-md">
        ...
        {/* VM Workspace URL for debugging */}
        {session.morphVmUrl && (
          <div className="mt-2 flex items-center gap-2 p-2 bg-gray-900/50 border border-gray-700 rounded-lg">
            ...
            <button
              onClick={() => navigator.clipboard.writeText(session.morphVmUrl!)}
        ...
        {session.morphInstanceId && !session.morphVmUrl && (
          <div className="mt-2 text-xs text-gray-500">
            Instance: {session.morphInstanceId}
          </div>
        )}
      </div>
