...
function ToolCallPart({ part }: { part: TurnPart }) {
  ...
  return (
    <div className={`bg-card/50 border rounded-lg my-2 overflow-hidden ${
      isChromeTool ? "border-cyan-600" : "border-border"
    }`}>
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-shrink-0 h-[55px] px-4 border-b border-border bg-background/80 backdrop-blur-md flex items-center">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-foreground">Browser Agent</span>
            {session.tokens && (
      ...
      <div className="flex-1 overflow-y-auto">
        {!morphInstanceId && (
          <div className="m-4 flex items-center gap-2 p-2 bg-muted/50 border border-border rounded-lg">
            ...
            <span className="text-xs text-muted-foreground">Waiting for VM to start...</span>
          </div>
        )}
      ...
      <div className="flex-shrink-0 px-4 py-2 border-t border-border text-xs text-muted-foreground/60 flex items-center justify-between">
