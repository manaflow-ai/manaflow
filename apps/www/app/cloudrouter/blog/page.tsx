...
export const metadata: Metadata = {
  ...
  description: "Updates and posts from the cloudrouter team.",
  openGraph: {
    title: "Blog — cloudrouter",
    description: "Updates and posts from the cloudrouter team.",
    type: "website",
      ...
      <div className="w-full max-w-2xl">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">
            Updates and posts from the cloudrouter team.
          </p>
        </section>
        ...
        <div className="flex flex-col gap-6">
          {posts.map((post) => (
            ...
            >
              ...
              <h2 className="mt-1 text-base font-semibold transition group-hover:text-neutral-600 dark:group-hover:text-neutral-300">
                {post.title}
              </h2>
