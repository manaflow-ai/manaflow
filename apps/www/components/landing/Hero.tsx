    ...
    <section className="relative min-h-screen flex items-start overflow-visible pt-20 pb-20 bg-transparent">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 text-left">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          <a
            href="https://cmux.sh"
            className="inline-flex items-center gap-2 bg-white text-black border border-neutral-300 px-4 py-2 rounded-full text-sm font-medium shadow-sm transition hover:bg-neutral-100"
          >
            <svg className="h-4 w-4 shrink-0" viewBox="4 2 16 20" fill="none">
              <defs>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-black text-white border border-neutral-700 px-4 py-2 rounded-full text-sm font-medium shadow-sm transition hover:bg-neutral-800"
          >
            <svg className="h-4 w-4 shrink-0 relative -top-px" viewBox="0 0 24 24" fill="currentColor">
