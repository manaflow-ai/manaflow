...
export default function Navbar() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/manaflow-ai/manaflow")
      .then((res) => res.json())
      .then((data) => {
      ...
      <div className="max-w-7xl mx-auto px-6 py-2.5">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center text-neutral-900 dark:text-white">
            ...
            <span className="text-base font-medium leading-none">Manaflow</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            >
              <svg className="w-4 h-4 shrink-0" viewBox="4 2 16 20" fill="none">
                <defs>
                  <linearGradient id="ctaLogoGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#00D4FF" />
                    <stop offset="100%" stopColor="#7C3AED" />
                  </linearGradient>
                </defs>
          ...
          <div className="md:hidden mt-4 pb-4 border-t border-neutral-200 dark:border-neutral-800 pt-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-4">
                ...
                >
                  <svg className="w-5 h-5 shrink-0" viewBox="4 2 16 20" fill="none">
                    <defs>
                      <linearGradient id="ctaMobileLogoGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#00D4FF" />
                        <stop offset="100%" stopColor="#7C3AED" />
                      </linearGradient>
                    </defs>
                    <path
                      d="M6 4L18 12L6 20V15.5L12.5 12L6 8.5V4Z"
                      fill="url(#ctaMobileLogoGradient)"
                    />
                  </svg>
                  Web
                </a>
