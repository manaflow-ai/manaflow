...
function PreviewDashboardInner({
  ...
  return (
    <div className="w-full max-w-5xl px-6 py-10 font-sans">
      ...
      {/* Example Preview Comment Section */}
      <div className="pt-10 lg:col-span-2">
        <Section title="Example PR comment">
          <div className="rounded-lg border border-white/10 bg-white/[0.02] backdrop-blur-sm overflow-hidden">
            {/* GitHub comment header mock */}
            <div className="flex items-center gap-3 px-4 py-3 border-b border-white/10 bg-white/[0.01]">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-neutral-500 bg-white/5 px-1.5 py-0.5 rounded">bot</span>
                <span className="text-xs text-neutral-500">commented just now</span>
              </div>
            </div>
            ...
            <div className="px-4 py-4 space-y-4">
              ...
              <p className="text-sm text-neutral-300">
                <a href="#" className="text-blue-400 hover:underline">Open Workspace (1 hr expiry)</a>
                <span className="text-neutral-500"> · </span>
                <a href="#" className="text-blue-400 hover:underline">Open Dev Browser (1 hr expiry)</a>
                <span className="text-neutral-500"> · </span>
                <a href="#" className="text-blue-400 hover:underline">Open Diff Heatmap</a>
              </p>

              {/* Commit info */}
              <p className="text-sm text-neutral-400">
                Captured 7 screenshots for commit <code className="bg-white/10 px-1.5 py-0.5 rounded text-xs font-mono text-neutral-300">5fc6367</code> (2025-12-04 04:03:32 UTC).
              </p>
              ...
              <div className="space-y-6 pt-2">
                {/* Screenshot 1 */}
                <div>
                  <p className="text-sm font-medium text-neutral-200 pb-3">
                    Bitbucket waitlist modal showing the empty form with email input and &apos;Join waitlist&apos; button
                  </p>
                  <div className="rounded-lg border border-white/10 overflow-hidden bg-neutral-950">
                    <div className="aspect-video bg-gradient-to-br from-neutral-900 to-neutral-950 flex items-center justify-center relative">
                      {/* Mock screenshot content */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-80 bg-neutral-800 rounded-lg shadow-2xl border border-neutral-700 p-6">
                          <h4 className="text-base font-semibold text-white pb-4">Join the Bitbucket waitlist</h4>
                          <div className="space-y-3">
                            <input
                              type="email"
                              placeholder="Enter your email"
                              className="w-full bg-neutral-700 border border-neutral-600 rounded px-3 py-2 text-sm text-white placeholder:text-neutral-400"
                              readOnly
                            />
                            <button className="w-full bg-[#0052cc] text-white rounded px-3 py-2 text-sm font-medium">
                              Join waitlist
                            </button>
                          </div>
                        </div>
                ...
                <div>
                  ...
                  <div className="rounded-lg border border-white/10 overflow-hidden bg-neutral-950">
                    <div className="aspect-video bg-gradient-to-br from-neutral-900 to-neutral-950 flex items-center justify-center relative">
                      {/* Mock screenshot content */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-80 bg-neutral-800 rounded-lg shadow-2xl border border-neutral-700 p-6 text-center">
                          <div className="h-12 w-12 rounded-full bg-emerald-500/10 mx-auto mb-4 flex items-center justify-center">
                            <CheckCircle2 className="h-6 w-6 text-emerald-500" />
                          </div>
                          <h4 className="text-base font-semibold text-white pb-2">You&apos;re on the list!</h4>
                          <p className="text-sm text-neutral-400">We&apos;ll notify you when GitLab support is available.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  <p className="text-sm font-medium text-neutral-200 pb-3">
                    Preview dashboard showing new GitLab and Bitbucket provider buttons alongside GitHub button
                  </p>
                  <div className="rounded-lg border border-white/10 overflow-hidden bg-neutral-950">
                    <div className="aspect-video bg-gradient-to-br from-neutral-900 to-neutral-950 flex items-center justify-center relative">
                      {/* Mock screenshot content */}
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="flex flex-col gap-3 w-64">
                          <button className="w-full h-10 bg-[#24292f] text-white rounded-lg flex items-center justify-center gap-2 text-sm font-medium">
                            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M12 0C5.374 0 0 5.373 0 12c0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0112 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z" />
                            </svg>
                            Continue with GitHub
                          </button>
                          <button className="w-full h-10 bg-[#fc6d26] text-white rounded-lg flex items-center justify-center gap-2 text-sm font-medium">
                            <svg className="h-4 w-4" viewBox="90 90 200 175" fill="currentColor">
                              <path d="M282.83,170.73l-.27-.69-26.14-68.22a6.81,6.81,0,0,0-2.69-3.24,7,7,0,0,0-8,.43,7,7,0,0,0-2.32,3.52l-17.65,54H154.29l-17.65-54A6.86,6.86,0,0,0,134.32,99a7,7,0,0,0-8-.43,6.87,6.87,0,0,0-2.69,3.24L97.44,170l-.26.69a48.54,48.54,0,0,0,16.1,56.1l.09.07.24.17,39.82,29.82,19.7,14.91,12,9.06a8.07,8.07,0,0,0,9.76,0l12-9.06,19.7-14.91,40.06-30,.1-.08A48.56,48.56,0,0,0,282.83,170.73Z" />
                            </svg>
                            Continue with GitLab
                          </button>
                          <button className="w-full h-10 bg-[#0052cc] text-white rounded-lg flex items-center justify-center gap-2 text-sm font-medium">
                            <svg className="h-4 w-4" viewBox="-2 -2 65 59" fill="currentColor">
                              <path d="M2 .82a2 2 0 00-2 2.32l8.49 51.54a2.7 2.7 0 00.91 1.61 2.71 2.71 0 001.75.66l15.76-18.88H24.7l-3.47-18.39h38.44l2.7-16.53a2 2 0 00-2-2.32L2 .82z" />
                            </svg>
                            Continue with Bitbucket
                          </button>
                        </div>
              ...
              <div className="pt-4 border-t border-white/10">
                <p className="text-xs text-neutral-500 italic">
                  Generated by <a href="https://cmux.sh" className="text-blue-400 hover:underline">cmux</a> preview system
                </p>
              </div>
            </div>
          </div>
