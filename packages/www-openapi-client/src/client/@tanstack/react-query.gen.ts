...
export const getApiPreviewConfigsByPreviewConfigIdEnvQueryKey = (options: Options<GetApiPreviewConfigsByPreviewConfigIdEnvData>) => createQueryKey('getApiPreviewConfigsByPreviewConfigIdEnv', options);

/**
 * Fetch environment variables for a preview configuration
 */
export const getApiPreviewConfigsByPreviewConfigIdEnvOptions = (options: Options<GetApiPreviewConfigsByPreviewConfigIdEnvData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiPreviewConfigsByPreviewConfigIdEnv({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiPreviewConfigsByPreviewConfigIdEnvQueryKey(options)
    });
};
 ...
 */
export const putApiPreviewConfigsByPreviewConfigIdEnvMutation = (options?: Partial<Options<PutApiPreviewConfigsByPreviewConfigIdEnvData>>): UseMutationOptions<PutApiPreviewConfigsByPreviewConfigIdEnvResponse, DefaultError, Options<PutApiPreviewConfigsByPreviewConfigIdEnvData>> => {
    const mutationOptions: UseMutationOptions<PutApiPreviewConfigsByPreviewConfigIdEnvResponse, DefaultError, Options<PutApiPreviewConfigsByPreviewConfigIdEnvData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await putApiPreviewConfigsByPreviewConfigIdEnv({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const postApiPreviewJobsDispatchMutation = (options?: Partial<Options<PostApiPreviewJobsDispatchData>>): UseMutationOptions<unknown, DefaultError, Options<PostApiPreviewJobsDispatchData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostApiPreviewJobsDispatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiPreviewJobsDispatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
