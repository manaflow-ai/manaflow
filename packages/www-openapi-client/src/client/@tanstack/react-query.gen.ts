 ...
 */
export const postApiIntegrationsGithubPrsMergeSimpleMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsMergeSimpleData>>): UseMutationOptions<PostApiIntegrationsGithubPrsMergeSimpleResponse, PostApiIntegrationsGithubPrsMergeSimpleError, Options<PostApiIntegrationsGithubPrsMergeSimpleData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsMergeSimpleResponse, PostApiIntegrationsGithubPrsMergeSimpleError, Options<PostApiIntegrationsGithubPrsMergeSimpleData>> = {
        mutationFn: async (fnOptions) => {
