...
export const getApiScreenshotCollectorLatestQueryKey = (options?: Options<GetApiScreenshotCollectorLatestData>) => createQueryKey('getApiScreenshotCollectorLatest', options);
 ...
 */
export const getApiScreenshotCollectorLatestOptions = (options?: Options<GetApiScreenshotCollectorLatestData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiScreenshotCollectorLatest({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiScreenshotCollectorLatestQueryKey(options)
    });
};