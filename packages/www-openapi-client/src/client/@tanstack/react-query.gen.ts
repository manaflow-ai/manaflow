...
export const getApiScriptsScreenshotCollectorQueryKey = (options?: Options<GetApiScriptsScreenshotCollectorData>) => createQueryKey('getApiScriptsScreenshotCollector', options);

/**
 * Get the screenshot collector script
 * Returns the bundled screenshot collector script that can be executed by workers
 */
export const getApiScriptsScreenshotCollectorOptions = (options?: Options<GetApiScriptsScreenshotCollectorData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiScriptsScreenshotCollector({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiScriptsScreenshotCollectorQueryKey(options)
    });
};
 ...
 */
export const postApiScriptsScreenshotCollectorInvalidateMutation = (options?: Partial<Options<PostApiScriptsScreenshotCollectorInvalidateData>>): UseMutationOptions<PostApiScriptsScreenshotCollectorInvalidateResponse, DefaultError, Options<PostApiScriptsScreenshotCollectorInvalidateData>> => {
    const mutationOptions: UseMutationOptions<PostApiScriptsScreenshotCollectorInvalidateResponse, DefaultError, Options<PostApiScriptsScreenshotCollectorInvalidateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiScriptsScreenshotCollectorInvalidate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
