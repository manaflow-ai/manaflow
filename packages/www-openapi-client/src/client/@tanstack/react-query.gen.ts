 ...
 */
export const postApiSandboxesByIdSpawnAgentMutation = (options?: Partial<Options<PostApiSandboxesByIdSpawnAgentData>>): UseMutationOptions<PostApiSandboxesByIdSpawnAgentResponse, DefaultError, Options<PostApiSandboxesByIdSpawnAgentData>> => {
    const mutationOptions: UseMutationOptions<PostApiSandboxesByIdSpawnAgentResponse, DefaultError, Options<PostApiSandboxesByIdSpawnAgentData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiSandboxesByIdSpawnAgent({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
