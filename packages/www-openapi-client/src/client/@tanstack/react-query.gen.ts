...
export const getApiIntegrationsGithubPrsReviewDataQueryKey = (options: Options<GetApiIntegrationsGithubPrsReviewDataData>) => createQueryKey('getApiIntegrationsGithubPrsReviewData', options);

/**
 * Fetch GitHub PR review data (reviews, review comments, issue comments) using the user's GitHub OAuth token
 */
export const getApiIntegrationsGithubPrsReviewDataOptions = (options: Options<GetApiIntegrationsGithubPrsReviewDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiIntegrationsGithubPrsReviewData({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiIntegrationsGithubPrsReviewDataQueryKey(options)
    });
};
 ...
 */
export const postApiIntegrationsGithubPrsReviewsMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsReviewsData>>): UseMutationOptions<PostApiIntegrationsGithubPrsReviewsResponse, DefaultError, Options<PostApiIntegrationsGithubPrsReviewsData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsReviewsResponse, DefaultError, Options<PostApiIntegrationsGithubPrsReviewsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiIntegrationsGithubPrsReviews({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiIntegrationsGithubPrsIssueCommentsMutation = (options?: Partial<Options<PostApiIntegrationsGithubPrsIssueCommentsData>>): UseMutationOptions<PostApiIntegrationsGithubPrsIssueCommentsResponse, DefaultError, Options<PostApiIntegrationsGithubPrsIssueCommentsData>> => {
    const mutationOptions: UseMutationOptions<PostApiIntegrationsGithubPrsIssueCommentsResponse, DefaultError, Options<PostApiIntegrationsGithubPrsIssueCommentsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiIntegrationsGithubPrsIssueComments({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
