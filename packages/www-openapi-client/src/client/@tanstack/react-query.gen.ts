 ...
 */
export const postApiDaemonTicketMutation = (options?: Partial<Options<PostApiDaemonTicketData>>): UseMutationOptions<PostApiDaemonTicketResponse, DefaultError, Options<PostApiDaemonTicketData>> => {
    const mutationOptions: UseMutationOptions<PostApiDaemonTicketResponse, DefaultError, Options<PostApiDaemonTicketData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiDaemonTicket({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiMobileAnalyticsMutation = (options?: Partial<Options<PostApiMobileAnalyticsData>>): UseMutationOptions<PostApiMobileAnalyticsResponse, DefaultError, Options<PostApiMobileAnalyticsData>> => {
    const mutationOptions: UseMutationOptions<PostApiMobileAnalyticsResponse, DefaultError, Options<PostApiMobileAnalyticsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMobileAnalytics({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiMobileHeartbeatMutation = (options?: Partial<Options<PostApiMobileHeartbeatData>>): UseMutationOptions<PostApiMobileHeartbeatResponse, DefaultError, Options<PostApiMobileHeartbeatData>> => {
    const mutationOptions: UseMutationOptions<PostApiMobileHeartbeatResponse, DefaultError, Options<PostApiMobileHeartbeatData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const postApiMobileWorkspacesMarkReadMutation = (options?: Partial<Options<PostApiMobileWorkspacesMarkReadData>>): UseMutationOptions<PostApiMobileWorkspacesMarkReadResponse, DefaultError, Options<PostApiMobileWorkspacesMarkReadData>> => {
    const mutationOptions: UseMutationOptions<PostApiMobileWorkspacesMarkReadResponse, DefaultError, Options<PostApiMobileWorkspacesMarkReadData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMobileWorkspacesMarkRead({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiMobilePushRegisterMutation = (options?: Partial<Options<PostApiMobilePushRegisterData>>): UseMutationOptions<PostApiMobilePushRegisterResponse, DefaultError, Options<PostApiMobilePushRegisterData>> => {
    const mutationOptions: UseMutationOptions<PostApiMobilePushRegisterResponse, DefaultError, Options<PostApiMobilePushRegisterData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMobilePushRegister({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiMobilePushRemoveMutation = (options?: Partial<Options<PostApiMobilePushRemoveData>>): UseMutationOptions<PostApiMobilePushRemoveResponse, DefaultError, Options<PostApiMobilePushRemoveData>> => {
    const mutationOptions: UseMutationOptions<PostApiMobilePushRemoveResponse, DefaultError, Options<PostApiMobilePushRemoveData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMobilePushRemove({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiMobilePushTestMutation = (options?: Partial<Options<PostApiMobilePushTestData>>): UseMutationOptions<PostApiMobilePushTestResponse, DefaultError, Options<PostApiMobilePushTestData>> => {
    const mutationOptions: UseMutationOptions<PostApiMobilePushTestResponse, DefaultError, Options<PostApiMobilePushTestData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiMobilePushTest({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
