...
export const getApiIntegrationsGithubCompareQueryKey = (options: Options<GetApiIntegrationsGithubCompareData>) => createQueryKey('getApiIntegrationsGithubCompare', options);

/**
 * Compare two branches/refs and return diffs with optional file contents
 */
export const getApiIntegrationsGithubCompareOptions = (options: Options<GetApiIntegrationsGithubCompareData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiIntegrationsGithubCompare({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiIntegrationsGithubCompareQueryKey(options)
    });
};
