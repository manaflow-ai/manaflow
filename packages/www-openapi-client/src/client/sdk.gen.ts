...
/**
 * Get the screenshot collector script
 * Returns the bundled screenshot collector script that can be executed by workers
 */
export const getApiScriptsScreenshotCollector = <ThrowOnError extends boolean = false>(options?: Options<GetApiScriptsScreenshotCollectorData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiScriptsScreenshotCollectorResponses, GetApiScriptsScreenshotCollectorErrors, ThrowOnError>({
...
/**
 * Get screenshot collector script metadata
 * Returns headers with script hash for cache validation
 */
export const headApiScriptsScreenshotCollector = <ThrowOnError extends boolean = false>(options?: Options<HeadApiScriptsScreenshotCollectorData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).head<HeadApiScriptsScreenshotCollectorResponses, HeadApiScriptsScreenshotCollectorErrors, ThrowOnError>({
        url: '/api/scripts/screenshot-collector',
        ...options
    });
};
 ...
 * Forces the next request to reload the script from disk
 */
export const postApiScriptsScreenshotCollectorInvalidate = <ThrowOnError extends boolean = false>(options?: Options<PostApiScriptsScreenshotCollectorInvalidateData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostApiScriptsScreenshotCollectorInvalidateResponses, unknown, ThrowOnError>({
