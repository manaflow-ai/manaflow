...
/**
 * Fetch environment variables for a preview configuration
 */
export const getApiPreviewConfigsByPreviewConfigIdEnv = <ThrowOnError extends boolean = false>(options: Options<GetApiPreviewConfigsByPreviewConfigIdEnvData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiPreviewConfigsByPreviewConfigIdEnvResponses, GetApiPreviewConfigsByPreviewConfigIdEnvErrors, ThrowOnError>({
...
/**
 * Update environment variables for a preview configuration
 */
export const putApiPreviewConfigsByPreviewConfigIdEnv = <ThrowOnError extends boolean = false>(options: Options<PutApiPreviewConfigsByPreviewConfigIdEnvData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutApiPreviewConfigsByPreviewConfigIdEnvResponses, PutApiPreviewConfigsByPreviewConfigIdEnvErrors, ThrowOnError>({
        url: '/api/preview/configs/{previewConfigId}/env',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const postApiPreviewJobsDispatch = <ThrowOnError extends boolean = false>(options: Options<PostApiPreviewJobsDispatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiPreviewJobsDispatchResponses, PostApiPreviewJobsDispatchErrors, ThrowOnError>({
