...
/**
 * Compare two branches/refs and return diffs with optional file contents
 */
export const getApiIntegrationsGithubCompare = <ThrowOnError extends boolean = false>(options: Options<GetApiIntegrationsGithubCompareData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiIntegrationsGithubCompareResponses, GetApiIntegrationsGithubCompareErrors, ThrowOnError>({
