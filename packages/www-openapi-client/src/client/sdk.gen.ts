...
/**
 * Spawn a Claude Code agent in a running sandbox
 * Creates a terminal with Claude Code running to assist with environment setup or other tasks.
 */
export const postApiSandboxesByIdSpawnAgent = <ThrowOnError extends boolean = false>(options: Options<PostApiSandboxesByIdSpawnAgentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiSandboxesByIdSpawnAgentResponses, PostApiSandboxesByIdSpawnAgentErrors, ThrowOnError>({
