...
/**
 * Get the latest screenshot collector release
 ...
 */
export const getApiScreenshotCollectorLatest = <ThrowOnError extends boolean = false>(options?: Options<GetApiScreenshotCollectorLatestData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiScreenshotCollectorLatestResponses, GetApiScreenshotCollectorLatestErrors, ThrowOnError>({
