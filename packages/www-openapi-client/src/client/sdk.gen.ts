...
/**
 * Mint a direct daemon ticket for a discovered workspace machine
 */
export const postApiDaemonTicket = <ThrowOnError extends boolean = false>(options: Options<PostApiDaemonTicketData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiDaemonTicketResponses, PostApiDaemonTicketErrors, ThrowOnError>({
...
/**
 * Capture a mobile analytics event through the HTTP boundary
 */
export const postApiMobileAnalytics = <ThrowOnError extends boolean = false>(options: Options<PostApiMobileAnalyticsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMobileAnalyticsResponses, PostApiMobileAnalyticsErrors, ThrowOnError>({
...
/**
 * Mark a mobile workspace row read through the HTTP boundary
 */
export const postApiMobileWorkspacesMarkRead = <ThrowOnError extends boolean = false>(options: Options<PostApiMobileWorkspacesMarkReadData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMobileWorkspacesMarkReadResponses, PostApiMobileWorkspacesMarkReadErrors, ThrowOnError>({
...
/**
 * Register an APNS token through the mobile HTTP boundary
 */
export const postApiMobilePushRegister = <ThrowOnError extends boolean = false>(options: Options<PostApiMobilePushRegisterData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMobilePushRegisterResponses, PostApiMobilePushRegisterErrors, ThrowOnError>({
...
/**
 * Remove an APNS token through the mobile HTTP boundary
 */
export const postApiMobilePushRemove = <ThrowOnError extends boolean = false>(options: Options<PostApiMobilePushRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMobilePushRemoveResponses, PostApiMobilePushRemoveErrors, ThrowOnError>({
...
/**
 * Send a test push through the mobile HTTP boundary
 */
export const postApiMobilePushTest = <ThrowOnError extends boolean = false>(options: Options<PostApiMobilePushTestData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiMobilePushTestResponses, PostApiMobilePushTestErrors, ThrowOnError>({
