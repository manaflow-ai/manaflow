 ...
 */
export const getApiIntegrationsGithubPrsReviewData = <ThrowOnError extends boolean = false>(options: Options<GetApiIntegrationsGithubPrsReviewDataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiIntegrationsGithubPrsReviewDataResponses, GetApiIntegrationsGithubPrsReviewDataErrors, ThrowOnError>({
 ...
 */
export const postApiIntegrationsGithubPrsReviews = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsReviewsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsReviewsResponses, PostApiIntegrationsGithubPrsReviewsErrors, ThrowOnError>({
...
/**
 * Create a GitHub issue comment on a pull request (PR conversation comment)
 */
export const postApiIntegrationsGithubPrsIssueComments = <ThrowOnError extends boolean = false>(options: Options<PostApiIntegrationsGithubPrsIssueCommentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiIntegrationsGithubPrsIssueCommentsResponses, PostApiIntegrationsGithubPrsIssueCommentsErrors, ThrowOnError>({
