...
/**
 * Get the activity record for an E2B instance (public query).
 */
...
/**
 * Get the activity record for an E2B instance (internal, for cron jobs).
 */
...
/**
 * Record that an E2B instance was resumed via the UI.
...
export const recordResume = authMutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      await ctx.db.insert("e2bInstanceActivity", {
...
/**
 * Record that an E2B instance was resumed (internal, for cron jobs).
 */
...
/**
 * Record that an E2B instance timeout was extended (pseudo-pause, internal).
 * E2B doesn't have native pause, so we extend the timeout instead.
 */
...
/**
 * Record that an E2B instance was stopped/killed (internal, for cron jobs).
 */
