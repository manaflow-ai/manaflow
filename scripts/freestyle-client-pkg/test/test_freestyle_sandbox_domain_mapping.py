...
class TestFreestyleSandboxDomainMapping(unittest.TestCase):
    """FreestyleSandboxDomainMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleSandboxDomainMapping:
        """Test FreestyleSandboxDomainMapping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleSandboxDomainMapping`
        """
        model = FreestyleSandboxDomainMapping()
        if include_optional:
            return FreestyleSandboxDomainMapping(
                id = '',
                domain = '',
                deployment_id = '',
                ownership_id = '',
    ...
    def testFreestyleSandboxDomainMapping(self):
        """Test FreestyleSandboxDomainMapping"""
