...
class TestDeleteVmResponses(unittest.TestCase):
    """DeleteVmResponses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteVmResponses:
        """Test DeleteVmResponses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteVmResponses`
        """
        model = DeleteVmResponses()
        if include_optional:
            return DeleteVmResponses(
                id = ''
            )
        else:
            return DeleteVmResponses(
    ...
    def testDeleteVmResponses(self):
        """Test DeleteVmResponses"""
