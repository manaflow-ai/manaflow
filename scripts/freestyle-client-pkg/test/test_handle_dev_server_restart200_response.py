...
class TestHandleDevServerRestart200Response(unittest.TestCase):
    """HandleDevServerRestart200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleDevServerRestart200Response:
        """Test HandleDevServerRestart200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleDevServerRestart200Response`
        """
        model = HandleDevServerRestart200Response()
        if include_optional:
            return HandleDevServerRestart200Response(
                restarted = True
            )
        else:
            return HandleDevServerRestart200Response(
    ...
    def testHandleDevServerRestart200Response(self):
        """Test HandleDevServerRestart200Response"""
