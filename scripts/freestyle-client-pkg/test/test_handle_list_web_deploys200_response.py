...
class TestHandleListWebDeploys200Response(unittest.TestCase):
    """HandleListWebDeploys200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleListWebDeploys200Response:
        """Test HandleListWebDeploys200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleListWebDeploys200Response`
        """
        model = HandleListWebDeploys200Response()
        if include_optional:
            return HandleListWebDeploys200Response(
                entries = [
                    freestyle_client.models.deployment_log_entry.DeploymentLogEntry(
                        deployment_id = '', 
                        account_id = '', 
    ...
    def testHandleListWebDeploys200Response(self):
        """Test HandleListWebDeploys200Response"""
