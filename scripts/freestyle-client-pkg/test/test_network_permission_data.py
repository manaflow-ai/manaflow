...
class TestNetworkPermissionData(unittest.TestCase):
    """NetworkPermissionData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkPermissionData:
        """Test NetworkPermissionData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkPermissionData`
        """
        model = NetworkPermissionData()
        if include_optional:
            return NetworkPermissionData(
                query = '',
                behavior = 'exact'
            )
        else:
    ...
    def testNetworkPermissionData(self):
        """Test NetworkPermissionData"""
