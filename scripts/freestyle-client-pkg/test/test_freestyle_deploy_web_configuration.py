...
class TestFreestyleDeployWebConfiguration(unittest.TestCase):
    """FreestyleDeployWebConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleDeployWebConfiguration:
        """Test FreestyleDeployWebConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleDeployWebConfiguration`
        """
        model = FreestyleDeployWebConfiguration()
        if include_optional:
            return FreestyleDeployWebConfiguration(
                domains = [
                    ''
                    ],
                entrypoint = '',
    ...
    def testFreestyleDeployWebConfiguration(self):
        """Test FreestyleDeployWebConfiguration"""
