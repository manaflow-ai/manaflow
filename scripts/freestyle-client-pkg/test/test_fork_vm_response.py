...
class TestForkVmResponse(unittest.TestCase):
    """ForkVmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForkVmResponse:
        """Test ForkVmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForkVmResponse`
        """
        model = ForkVmResponse()
        if include_optional:
