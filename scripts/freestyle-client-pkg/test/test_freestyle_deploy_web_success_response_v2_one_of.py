...
class TestFreestyleDeployWebSuccessResponseV2OneOf(unittest.TestCase):
    """FreestyleDeployWebSuccessResponseV2OneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleDeployWebSuccessResponseV2OneOf:
        """Test FreestyleDeployWebSuccessResponseV2OneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleDeployWebSuccessResponseV2OneOf`
        """
        model = FreestyleDeployWebSuccessResponseV2OneOf()
        if include_optional:
            return FreestyleDeployWebSuccessResponseV2OneOf(
                deployment_id = '',
                project_id = '',
                domains = [
                    ''
    ...
    def testFreestyleDeployWebSuccessResponseV2OneOf(self):
        """Test FreestyleDeployWebSuccessResponseV2OneOf"""
