...
class TestReadFileEphemeralDevServerResponses(unittest.TestCase):
    """ReadFileEphemeralDevServerResponses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadFileEphemeralDevServerResponses:
        """Test ReadFileEphemeralDevServerResponses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadFileEphemeralDevServerResponses`
        """
        model = ReadFileEphemeralDevServerResponses()
        if include_optional:
            return ReadFileEphemeralDevServerResponses(
                content = None,
                exists = True,
                path = ''
            )
    ...
    def testReadFileEphemeralDevServerResponses(self):
        """Test ReadFileEphemeralDevServerResponses"""
