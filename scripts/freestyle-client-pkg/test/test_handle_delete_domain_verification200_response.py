...
class TestHandleDeleteDomainVerification200Response(unittest.TestCase):
    """HandleDeleteDomainVerification200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleDeleteDomainVerification200Response:
        """Test HandleDeleteDomainVerification200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleDeleteDomainVerification200Response`
        """
        model = HandleDeleteDomainVerification200Response()
        if include_optional:
            return HandleDeleteDomainVerification200Response(
                verification_code = '',
                domain = 'example.com'
            )
        else:
    ...
    def testHandleDeleteDomainVerification200Response(self):
        """Test HandleDeleteDomainVerification200Response"""
