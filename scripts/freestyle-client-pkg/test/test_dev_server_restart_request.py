...
class TestDevServerRestartRequest(unittest.TestCase):
    """DevServerRestartRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevServerRestartRequest:
        """Test DevServerRestartRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevServerRestartRequest`
        """
        model = DevServerRestartRequest()
        if include_optional:
            return DevServerRestartRequest(
    ...
    def testDevServerRestartRequest(self):
        """Test DevServerRestartRequest"""
