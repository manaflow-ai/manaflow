...
class TestWaitVmResponse(unittest.TestCase):
    """WaitVmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaitVmResponse:
        """Test WaitVmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaitVmResponse`
        """
        model = WaitVmResponse()
        if include_optional:
            return WaitVmResponse(
                id = '',
                exit_status = ''
            )
        else:
