...
class TestFreestyleDomainVerificationRequest(unittest.TestCase):
    """FreestyleDomainVerificationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleDomainVerificationRequest:
        """Test FreestyleDomainVerificationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleDomainVerificationRequest`
        """
        model = FreestyleDomainVerificationRequest()
        if include_optional:
            return FreestyleDomainVerificationRequest(
                domain = 'example.com'
            )
        else:
            return FreestyleDomainVerificationRequest(
    ...
    def testFreestyleDomainVerificationRequest(self):
        """Test FreestyleDomainVerificationRequest"""
