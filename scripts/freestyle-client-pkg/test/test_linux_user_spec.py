...
class TestLinuxUserSpec(unittest.TestCase):
    """LinuxUserSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinuxUserSpec:
        """Test LinuxUserSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinuxUserSpec`
        """
        model = LinuxUserSpec()
        if include_optional:
            return LinuxUserSpec(
                name = '',
                uid = 0,
                gecos = '',
                groups = [
