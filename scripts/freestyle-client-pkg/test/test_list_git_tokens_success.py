...
class TestListGitTokensSuccess(unittest.TestCase):
    """ListGitTokensSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGitTokensSuccess:
        """Test ListGitTokensSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGitTokensSuccess`
        """
        model = ListGitTokensSuccess()
        if include_optional:
            return ListGitTokensSuccess(
                tokens = [
                    freestyle_client.models.access_token_info.AccessTokenInfo(
                        id = '', )
                    ]
            )
        else:
    ...
    def testListGitTokensSuccess(self):
        """Test ListGitTokensSuccess"""
