...
class TestExecAwaitVmResponse(unittest.TestCase):
    """ExecAwaitVmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecAwaitVmResponse:
        """Test ExecAwaitVmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecAwaitVmResponse`
        """
        model = ExecAwaitVmResponse()
        if include_optional:
            return ExecAwaitVmResponse(
                stdout = '',
                stderr = '',
                status_code = 56
            )
    ...
    def testExecAwaitVmResponse(self):
        """Test ExecAwaitVmResponse"""
