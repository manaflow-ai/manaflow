...
class TestGrantVmPermissionRequest(unittest.TestCase):
    """GrantVmPermissionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantVmPermissionRequest:
        """Test GrantVmPermissionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantVmPermissionRequest`
        """
        model = GrantVmPermissionRequest()
        if include_optional:
            return GrantVmPermissionRequest(
                allowed_users = [
                    ''
                    ]
            )
    ...
    def testGrantVmPermissionRequest(self):
        """Test GrantVmPermissionRequest"""
