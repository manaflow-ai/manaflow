...
class TestHandleCreateGitTriggerRequest(unittest.TestCase):
    """HandleCreateGitTriggerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleCreateGitTriggerRequest:
        """Test HandleCreateGitTriggerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleCreateGitTriggerRequest`
        """
        model = HandleCreateGitTriggerRequest()
        if include_optional:
            return HandleCreateGitTriggerRequest(
    ...
    def testHandleCreateGitTriggerRequest(self):
        """Test HandleCreateGitTriggerRequest"""
