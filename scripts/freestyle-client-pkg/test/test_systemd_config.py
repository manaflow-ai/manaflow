...
class TestSystemdConfig(unittest.TestCase):
    """SystemdConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemdConfig:
        """Test SystemdConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemdConfig`
        """
        model = SystemdConfig()
        if include_optional:
