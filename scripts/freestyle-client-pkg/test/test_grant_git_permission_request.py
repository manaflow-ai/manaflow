...
class TestGrantGitPermissionRequest(unittest.TestCase):
    """GrantGitPermissionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantGitPermissionRequest:
        """Test GrantGitPermissionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantGitPermissionRequest`
        """
        model = GrantGitPermissionRequest()
        if include_optional:
            return GrantGitPermissionRequest(
                permission = 'read'
            )
        else:
            return GrantGitPermissionRequest(
    ...
    def testGrantGitPermissionRequest(self):
        """Test GrantGitPermissionRequest"""
