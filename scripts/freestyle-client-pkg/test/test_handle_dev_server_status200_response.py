...
class TestHandleDevServerStatus200Response(unittest.TestCase):
    """HandleDevServerStatus200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleDevServerStatus200Response:
        """Test HandleDevServerStatus200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleDevServerStatus200Response`
        """
        model = HandleDevServerStatus200Response()
        if include_optional:
            return HandleDevServerStatus200Response(
                installing = True,
                dev_running = True
            )
        else:
    ...
    def testHandleDevServerStatus200Response(self):
        """Test HandleDevServerStatus200Response"""
