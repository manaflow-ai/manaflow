...
class TestFreestyleExecuteScriptParamsConfiguration(unittest.TestCase):
    """FreestyleExecuteScriptParamsConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleExecuteScriptParamsConfiguration:
        """Test FreestyleExecuteScriptParamsConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleExecuteScriptParamsConfiguration`
        """
        model = FreestyleExecuteScriptParamsConfiguration()
        if include_optional:
            return FreestyleExecuteScriptParamsConfiguration(
    ...
    def testFreestyleExecuteScriptParamsConfiguration(self):
        """Test FreestyleExecuteScriptParamsConfiguration"""
