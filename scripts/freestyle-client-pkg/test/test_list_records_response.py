...
class TestListRecordsResponse(unittest.TestCase):
    """ListRecordsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRecordsResponse:
        """Test ListRecordsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRecordsResponse`
        """
        model = ListRecordsResponse()
        if include_optional:
            return ListRecordsResponse(
                records = [
                    freestyle_client.models.dns_record.DnsRecord(
                        kind = 'A', 
                        name = '', 
                        value = '', 
                        ttl = '', 
    ...
    def testListRecordsResponse(self):
        """Test ListRecordsResponse"""
