...
class TestTerminalListResponse(unittest.TestCase):
    """TerminalListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerminalListResponse:
        """Test TerminalListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerminalListResponse`
        """
        model = TerminalListResponse()
        if include_optional:
            return TerminalListResponse(
                terminals = [
                    freestyle_client.models.terminal_session.TerminalSession(
                        name = '', 
                        status = '', 
                        created = '', )
                    ]
    ...
    def testTerminalListResponse(self):
        """Test TerminalListResponse"""
