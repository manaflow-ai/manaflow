...
class TestGitRepositorySpec(unittest.TestCase):
    """GitRepositorySpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitRepositorySpec:
        """Test GitRepositorySpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitRepositorySpec`
        """
        model = GitRepositorySpec()
        if include_optional:
    ...
    def testGitRepositorySpec(self):
        """Test GitRepositorySpec"""
