...
class TestVmTemplatePortsInner(unittest.TestCase):
    """VmTemplatePortsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VmTemplatePortsInner:
        """Test VmTemplatePortsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VmTemplatePortsInner`
        """
        model = VmTemplatePortsInner()
        if include_optional:
            return VmTemplatePortsInner(
                port = 0,
                target_port = 0
            )
        else:
    ...
    def testVmTemplatePortsInner(self):
        """Test VmTemplatePortsInner"""
