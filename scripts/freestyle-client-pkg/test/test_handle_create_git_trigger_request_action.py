...
class TestHandleCreateGitTriggerRequestAction(unittest.TestCase):
    """HandleCreateGitTriggerRequestAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleCreateGitTriggerRequestAction:
        """Test HandleCreateGitTriggerRequestAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleCreateGitTriggerRequestAction`
        """
        model = HandleCreateGitTriggerRequestAction()
        if include_optional:
            return HandleCreateGitTriggerRequestAction(
                endpoint = '',
                action = 'webhook'
            )
        else:
    ...
    def testHandleCreateGitTriggerRequestAction(self):
        """Test HandleCreateGitTriggerRequestAction"""
