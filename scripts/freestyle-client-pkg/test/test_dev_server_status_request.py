...
class TestDevServerStatusRequest(unittest.TestCase):
    """DevServerStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevServerStatusRequest:
        """Test DevServerStatusRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevServerStatusRequest`
        """
        model = DevServerStatusRequest()
        if include_optional:
            return DevServerStatusRequest(
    ...
    def testDevServerStatusRequest(self):
        """Test DevServerStatusRequest"""
