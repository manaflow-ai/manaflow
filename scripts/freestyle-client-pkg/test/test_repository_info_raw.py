...
class TestRepositoryInfoRaw(unittest.TestCase):
    """RepositoryInfoRaw unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RepositoryInfoRaw:
        """Test RepositoryInfoRaw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RepositoryInfoRaw`
        """
        model = RepositoryInfoRaw()
        if include_optional:
            return RepositoryInfoRaw(
                id = '',
                name = '',
                account_id = '',
                visibility = 'public',
    ...
    def testRepositoryInfoRaw(self):
        """Test RepositoryInfoRaw"""
