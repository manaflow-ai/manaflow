...
class TestFreestyleJavaScriptLog(unittest.TestCase):
    """FreestyleJavaScriptLog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleJavaScriptLog:
        """Test FreestyleJavaScriptLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleJavaScriptLog`
        """
        model = FreestyleJavaScriptLog()
        if include_optional:
            return FreestyleJavaScriptLog(
                message = 'I'm a log!',
                type = 'log'
            )
        else:
    ...
    def testFreestyleJavaScriptLog(self):
        """Test FreestyleJavaScriptLog"""
