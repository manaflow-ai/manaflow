...
class TestResizeVmRequest(unittest.TestCase):
    """ResizeVmRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResizeVmRequest:
        """Test ResizeVmRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResizeVmRequest`
        """
        model = ResizeVmRequest()
        if include_optional:
