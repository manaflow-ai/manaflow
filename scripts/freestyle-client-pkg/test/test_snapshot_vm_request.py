...
class TestSnapshotVmRequest(unittest.TestCase):
    """SnapshotVmRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnapshotVmRequest:
        """Test SnapshotVmRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotVmRequest`
        """
        model = SnapshotVmRequest()
        if include_optional:
            return SnapshotVmRequest(
                name = ''
            )
        else:
            return SnapshotVmRequest(
    ...
    def testSnapshotVmRequest(self):
        """Test SnapshotVmRequest"""
