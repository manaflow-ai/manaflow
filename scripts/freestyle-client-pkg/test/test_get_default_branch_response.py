...
class TestGetDefaultBranchResponse(unittest.TestCase):
    """GetDefaultBranchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDefaultBranchResponse:
        """Test GetDefaultBranchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDefaultBranchResponse`
        """
        model = GetDefaultBranchResponse()
        if include_optional:
    ...
    def testGetDefaultBranchResponse(self):
        """Test GetDefaultBranchResponse"""
