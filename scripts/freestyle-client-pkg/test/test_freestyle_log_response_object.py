...
class TestFreestyleLogResponseObject(unittest.TestCase):
    """FreestyleLogResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleLogResponseObject:
        """Test FreestyleLogResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleLogResponseObject`
        """
        model = FreestyleLogResponseObject()
        if include_optional:
            return FreestyleLogResponseObject(
                message = '',
                timestamp = ''
            )
        else:
    ...
    def testFreestyleLogResponseObject(self):
        """Test FreestyleLogResponseObject"""
