...
class TestHandleShutdownDevServer200Response(unittest.TestCase):
    """HandleShutdownDevServer200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleShutdownDevServer200Response:
        """Test HandleShutdownDevServer200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleShutdownDevServer200Response`
        """
        model = HandleShutdownDevServer200Response()
        if include_optional:
            return HandleShutdownDevServer200Response(
                shutdown = True
            )
        else:
            return HandleShutdownDevServer200Response(
    ...
    def testHandleShutdownDevServer200Response(self):
        """Test HandleShutdownDevServer200Response"""
