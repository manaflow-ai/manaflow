...
class TestFreestyleCloudstateDeployConfiguration(unittest.TestCase):
    """FreestyleCloudstateDeployConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleCloudstateDeployConfiguration:
        """Test FreestyleCloudstateDeployConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleCloudstateDeployConfiguration`
        """
        model = FreestyleCloudstateDeployConfiguration()
        if include_optional:
            return FreestyleCloudstateDeployConfiguration(
                domains = [
                    ''
                    ],
                env_vars = {
    ...
    def testFreestyleCloudstateDeployConfiguration(self):
        """Test FreestyleCloudstateDeployConfiguration"""
