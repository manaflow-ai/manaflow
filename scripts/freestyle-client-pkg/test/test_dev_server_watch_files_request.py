...
class TestDevServerWatchFilesRequest(unittest.TestCase):
    """DevServerWatchFilesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevServerWatchFilesRequest:
        """Test DevServerWatchFilesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevServerWatchFilesRequest`
        """
        model = DevServerWatchFilesRequest()
        if include_optional:
            return DevServerWatchFilesRequest(
                dev_server = freestyle_client.models.dev_server_identifier.DevServerIdentifier(
                    repo_id = '', 
                    git_ref = '', )
            )
        else:
    ...
    def testDevServerWatchFilesRequest(self):
        """Test DevServerWatchFilesRequest"""
