...
class TestRevokeGitTokenRequest(unittest.TestCase):
    """RevokeGitTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevokeGitTokenRequest:
        """Test RevokeGitTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevokeGitTokenRequest`
        """
        model = RevokeGitTokenRequest()
        if include_optional:
            return RevokeGitTokenRequest(
                token_id = ''
            )
        else:
            return RevokeGitTokenRequest(
    ...
    def testRevokeGitTokenRequest(self):
        """Test RevokeGitTokenRequest"""
