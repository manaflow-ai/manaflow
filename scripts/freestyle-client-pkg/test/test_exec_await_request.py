...
class TestExecAwaitRequest(unittest.TestCase):
    """ExecAwaitRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecAwaitRequest:
        """Test ExecAwaitRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecAwaitRequest`
        """
        model = ExecAwaitRequest()
        if include_optional:
            return ExecAwaitRequest(
                command = '',
                terminal = '',
                timeout_ms = 0
            )
