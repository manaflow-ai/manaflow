...
class TestFreestyleDeployWebSuccessResponseV2OneOf1(unittest.TestCase):
    """FreestyleDeployWebSuccessResponseV2OneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleDeployWebSuccessResponseV2OneOf1:
        """Test FreestyleDeployWebSuccessResponseV2OneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleDeployWebSuccessResponseV2OneOf1`
        """
        model = FreestyleDeployWebSuccessResponseV2OneOf1()
        if include_optional:
            return FreestyleDeployWebSuccessResponseV2OneOf1(
                deployment_id = ''
            )
        else:
            return FreestyleDeployWebSuccessResponseV2OneOf1(
    ...
    def testFreestyleDeployWebSuccessResponseV2OneOf1(self):
        """Test FreestyleDeployWebSuccessResponseV2OneOf1"""
