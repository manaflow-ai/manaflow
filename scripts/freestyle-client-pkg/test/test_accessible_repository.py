...
class TestAccessibleRepository(unittest.TestCase):
    """AccessibleRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessibleRepository:
        """Test AccessibleRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessibleRepository`
        """
        model = AccessibleRepository()
        if include_optional:
    ...
    def testAccessibleRepository(self):
        """Test AccessibleRepository"""
