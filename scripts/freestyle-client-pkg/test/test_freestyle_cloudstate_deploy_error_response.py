...
class TestFreestyleCloudstateDeployErrorResponse(unittest.TestCase):
    """FreestyleCloudstateDeployErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleCloudstateDeployErrorResponse:
        """Test FreestyleCloudstateDeployErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleCloudstateDeployErrorResponse`
        """
        model = FreestyleCloudstateDeployErrorResponse()
        if include_optional:
            return FreestyleCloudstateDeployErrorResponse(
                message = ''
            )
        else:
            return FreestyleCloudstateDeployErrorResponse(
    ...
    def testFreestyleCloudstateDeployErrorResponse(self):
        """Test FreestyleCloudstateDeployErrorResponse"""
