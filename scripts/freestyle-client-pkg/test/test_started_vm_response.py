...
class TestStartedVmResponse(unittest.TestCase):
    """StartedVmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartedVmResponse:
        """Test StartedVmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartedVmResponse`
        """
        model = StartedVmResponse()
        if include_optional:
            return StartedVmResponse(
                id = '',
                domains = [
                    ''
                    ],
    ...
    def testStartedVmResponse(self):
        """Test StartedVmResponse"""
