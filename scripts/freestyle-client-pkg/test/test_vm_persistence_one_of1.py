...
class TestVmPersistenceOneOf1(unittest.TestCase):
    """VmPersistenceOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VmPersistenceOneOf1:
        """Test VmPersistenceOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VmPersistenceOneOf1`
        """
        model = VmPersistenceOneOf1()
        if include_optional:
            return VmPersistenceOneOf1(
                delete_event = 'OnStop',
                type = 'ephemeral'
            )
        else:
    ...
    def testVmPersistenceOneOf1(self):
        """Test VmPersistenceOneOf1"""
