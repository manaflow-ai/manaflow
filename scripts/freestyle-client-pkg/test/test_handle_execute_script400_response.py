...
class TestHandleExecuteScript400Response(unittest.TestCase):
    """HandleExecuteScript400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleExecuteScript400Response:
        """Test HandleExecuteScript400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleExecuteScript400Response`
        """
        model = HandleExecuteScript400Response()
        if include_optional:
            return HandleExecuteScript400Response(
                error = '',
                logs = [
    ...
    def testHandleExecuteScript400Response(self):
        """Test HandleExecuteScript400Response"""
