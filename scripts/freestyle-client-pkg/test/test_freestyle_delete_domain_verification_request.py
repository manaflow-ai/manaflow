...
class TestFreestyleDeleteDomainVerificationRequest(unittest.TestCase):
    """FreestyleDeleteDomainVerificationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleDeleteDomainVerificationRequest:
        """Test FreestyleDeleteDomainVerificationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleDeleteDomainVerificationRequest`
        """
        model = FreestyleDeleteDomainVerificationRequest()
        if include_optional:
            return FreestyleDeleteDomainVerificationRequest(
                domain = 'example.com',
                verification_code = ''
            )
        else:
    ...
    def testFreestyleDeleteDomainVerificationRequest(self):
        """Test FreestyleDeleteDomainVerificationRequest"""
