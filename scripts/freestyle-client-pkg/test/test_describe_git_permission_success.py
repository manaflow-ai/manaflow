...
class TestDescribeGitPermissionSuccess(unittest.TestCase):
    """DescribeGitPermissionSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeGitPermissionSuccess:
        """Test DescribeGitPermissionSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeGitPermissionSuccess`
        """
        model = DescribeGitPermissionSuccess()
        if include_optional:
            return DescribeGitPermissionSuccess(
                identity = '',
                repo = '',
                access_level = 'read'
            )
    ...
    def testDescribeGitPermissionSuccess(self):
        """Test DescribeGitPermissionSuccess"""
