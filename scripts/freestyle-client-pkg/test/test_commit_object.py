...
class TestCommitObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommitObject:
        """Test CommitObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitObject`
        """
        model = CommitObject()
        if include_optional:
            return CommitObject(
                author = freestyle_client.models.signature.Signature(
                    date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    name = '', 
                    email = '', ),
                committer = freestyle_client.models.signature.Signature(
                    date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    name = '', 
                    email = '', ),
                message = '',
                tree = freestyle_client.models.commit_tree.CommitTree(
                    sha = '', ),
                parents = [
                    freestyle_client.models.commit_parent.CommitParent(
                        sha = '', )
                    ],
                sha = ''
            )
