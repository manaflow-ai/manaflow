...
class TestSystemdUnitSpec(unittest.TestCase):
    """SystemdUnitSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemdUnitSpec:
        """Test SystemdUnitSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemdUnitSpec`
        """
        model = SystemdUnitSpec()
        if include_optional:
