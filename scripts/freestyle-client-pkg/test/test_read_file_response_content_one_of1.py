...
class TestReadFileResponseContentOneOf1(unittest.TestCase):
    """ReadFileResponseContentOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadFileResponseContentOneOf1:
        """Test ReadFileResponseContentOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadFileResponseContentOneOf1`
        """
        model = ReadFileResponseContentOneOf1()
        if include_optional:
            return ReadFileResponseContentOneOf1(
                files = [
                    ''
                    ],
                kind = 'directory'
    ...
    def testReadFileResponseContentOneOf1(self):
        """Test ReadFileResponseContentOneOf1"""
