...
class TestCreatedToken(unittest.TestCase):
    """CreatedToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatedToken:
        """Test CreatedToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatedToken`
        """
        model = CreatedToken()
        if include_optional:
            return CreatedToken(
