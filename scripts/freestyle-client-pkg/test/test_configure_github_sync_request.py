...
class TestConfigureGithubSyncRequest(unittest.TestCase):
    """ConfigureGithubSyncRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureGithubSyncRequest:
        """Test ConfigureGithubSyncRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigureGithubSyncRequest`
        """
        model = ConfigureGithubSyncRequest()
        if include_optional:
            return ConfigureGithubSyncRequest(
                github_repo_name = ''
            )
        else:
            return ConfigureGithubSyncRequest(
    ...
    def testConfigureGithubSyncRequest(self):
        """Test ConfigureGithubSyncRequest"""
