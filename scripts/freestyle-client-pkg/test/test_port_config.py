...
class TestPortConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PortConfig:
        """Test PortConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortConfig`
        """
        model = PortConfig()
        if include_optional:
            return PortConfig(
