...
class TestAdditionalRepository(unittest.TestCase):
    """AdditionalRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalRepository:
        """Test AdditionalRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalRepository`
        """
    ...
    def testAdditionalRepository(self):
        """Test AdditionalRepository"""
