...
class TestDnsRecordData(unittest.TestCase):
    """DnsRecordData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DnsRecordData:
        """Test DnsRecordData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DnsRecordData`
        """
        model = DnsRecordData()
        if include_optional:
