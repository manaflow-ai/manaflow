...
class TestListIdentitiesSuccess(unittest.TestCase):
    """ListIdentitiesSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListIdentitiesSuccess:
        """Test ListIdentitiesSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListIdentitiesSuccess`
        """
        model = ListIdentitiesSuccess()
        if include_optional:
            return ListIdentitiesSuccess(
                identities = [
                    freestyle_client.models.freestyle_identity.FreestyleIdentity(
                        id = '', 
                        managed = True, )
                    ],
                offset = 0,
    ...
    def testListIdentitiesSuccess(self):
        """Test ListIdentitiesSuccess"""
