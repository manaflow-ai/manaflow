...
class TestGitReference(unittest.TestCase):
    """GitReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitReference:
        """Test GitReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitReference`
        """
        model = GitReference()
        if include_optional:
            return GitReference(
