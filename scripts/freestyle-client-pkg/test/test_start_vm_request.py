...
class TestStartVmRequest(unittest.TestCase):
    """StartVmRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartVmRequest:
        """Test StartVmRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartVmRequest`
        """
        model = StartVmRequest()
        if include_optional:
