...
class TestTagTarget(unittest.TestCase):
    """TagTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagTarget:
        """Test TagTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagTarget`
        """
        model = TagTarget()
        if include_optional:
            return TagTarget(
