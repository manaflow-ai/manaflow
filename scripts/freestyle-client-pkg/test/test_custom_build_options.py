...
class TestCustomBuildOptions(unittest.TestCase):
    """CustomBuildOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomBuildOptions:
        """Test CustomBuildOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomBuildOptions`
        """
        model = CustomBuildOptions()
        if include_optional:
    ...
    def testCustomBuildOptions(self):
        """Test CustomBuildOptions"""
