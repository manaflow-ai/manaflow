...
class TestDeploymentBuildOptions(unittest.TestCase):
    """DeploymentBuildOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentBuildOptions:
        """Test DeploymentBuildOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentBuildOptions`
        """
        model = DeploymentBuildOptions()
        if include_optional:
            return DeploymentBuildOptions(
                command = '',
                out_dir = '',
                env_vars = {
                    'key' : ''
    ...
    def testDeploymentBuildOptions(self):
        """Test DeploymentBuildOptions"""
