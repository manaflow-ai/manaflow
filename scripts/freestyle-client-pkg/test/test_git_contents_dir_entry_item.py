...
class TestGitContentsDirEntryItem(unittest.TestCase):
    """GitContentsDirEntryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitContentsDirEntryItem:
        """Test GitContentsDirEntryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitContentsDirEntryItem`
        """
        model = GitContentsDirEntryItem()
        if include_optional:
            return GitContentsDirEntryItem(
                name = '',
                path = '',
                sha = '',
                size = 0,
    ...
    def testGitContentsDirEntryItem(self):
        """Test GitContentsDirEntryItem"""
