...
class TestFreestyleCloudstateDeployRequest(unittest.TestCase):
    """FreestyleCloudstateDeployRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleCloudstateDeployRequest:
        """Test FreestyleCloudstateDeployRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleCloudstateDeployRequest`
        """
        model = FreestyleCloudstateDeployRequest()
        if include_optional:
            return FreestyleCloudstateDeployRequest(
                classes = '',
                config = freestyle_client.models.freestyle_cloudstate_deploy_configuration.FreestyleCloudstateDeployConfiguration(
                    domains = [
                        ''
                        ], 
                    env_vars = {
    ...
    def testFreestyleCloudstateDeployRequest(self):
        """Test FreestyleCloudstateDeployRequest"""
