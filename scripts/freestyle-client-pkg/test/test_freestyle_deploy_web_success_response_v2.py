...
class TestFreestyleDeployWebSuccessResponseV2(unittest.TestCase):
    """FreestyleDeployWebSuccessResponseV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleDeployWebSuccessResponseV2:
        """Test FreestyleDeployWebSuccessResponseV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleDeployWebSuccessResponseV2`
        """
        model = FreestyleDeployWebSuccessResponseV2()
        if include_optional:
            return FreestyleDeployWebSuccessResponseV2(
                deployment_id = '',
                project_id = '',
                domains = [
                    ''
    ...
    def testFreestyleDeployWebSuccessResponseV2(self):
        """Test FreestyleDeployWebSuccessResponseV2"""
