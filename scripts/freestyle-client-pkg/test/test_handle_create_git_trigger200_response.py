...
class TestHandleCreateGitTrigger200Response(unittest.TestCase):
    """HandleCreateGitTrigger200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleCreateGitTrigger200Response:
        """Test HandleCreateGitTrigger200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleCreateGitTrigger200Response`
        """
        model = HandleCreateGitTrigger200Response()
        if include_optional:
            return HandleCreateGitTrigger200Response(
                trigger_id = ''
            )
        else:
            return HandleCreateGitTrigger200Response(
    ...
    def testHandleCreateGitTrigger200Response(self):
        """Test HandleCreateGitTrigger200Response"""
