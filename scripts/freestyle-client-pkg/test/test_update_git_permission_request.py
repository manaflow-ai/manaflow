...
class TestUpdateGitPermissionRequest(unittest.TestCase):
    """UpdateGitPermissionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateGitPermissionRequest:
        """Test UpdateGitPermissionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateGitPermissionRequest`
        """
        model = UpdateGitPermissionRequest()
        if include_optional:
            return UpdateGitPermissionRequest(
                permission = 'read'
            )
        else:
            return UpdateGitPermissionRequest(
    ...
    def testUpdateGitPermissionRequest(self):
        """Test UpdateGitPermissionRequest"""
