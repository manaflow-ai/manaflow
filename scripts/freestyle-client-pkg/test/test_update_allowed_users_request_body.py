...
class TestUpdateAllowedUsersRequestBody(unittest.TestCase):
    """UpdateAllowedUsersRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAllowedUsersRequestBody:
        """Test UpdateAllowedUsersRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAllowedUsersRequestBody`
        """
        model = UpdateAllowedUsersRequestBody()
        if include_optional:
            return UpdateAllowedUsersRequestBody(
                allowed_users = [
                    ''
                    ]
            )
    ...
    def testUpdateAllowedUsersRequestBody(self):
        """Test UpdateAllowedUsersRequestBody"""
