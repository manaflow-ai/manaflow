...
class TestCreateRepoImport(unittest.TestCase):
    """CreateRepoImport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRepoImport:
        """Test CreateRepoImport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRepoImport`
        """
        model = CreateRepoImport()
        if include_optional:
            return CreateRepoImport(
                files = {
                    'key' : ''
                    },
                commit_message = '',
