...
class TestBranchDetails(unittest.TestCase):
    """BranchDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BranchDetails:
        """Test BranchDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BranchDetails`
        """
        model = BranchDetails()
        if include_optional:
