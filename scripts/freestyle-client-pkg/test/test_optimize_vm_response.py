...
class TestOptimizeVmResponse(unittest.TestCase):
    """OptimizeVmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptimizeVmResponse:
        """Test OptimizeVmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizeVmResponse`
        """
        model = OptimizeVmResponse()
        if include_optional:
            return OptimizeVmResponse(
                id = '',
                message = ''
            )
        else:
    ...
    def testOptimizeVmResponse(self):
        """Test OptimizeVmResponse"""
