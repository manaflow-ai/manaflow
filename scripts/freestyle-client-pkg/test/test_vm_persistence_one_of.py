...
class TestVmPersistenceOneOf(unittest.TestCase):
    """VmPersistenceOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VmPersistenceOneOf:
        """Test VmPersistenceOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VmPersistenceOneOf`
        """
        model = VmPersistenceOneOf()
        if include_optional:
            return VmPersistenceOneOf(
                priority = 0,
                type = 'sticky'
            )
        else:
    ...
    def testVmPersistenceOneOf(self):
        """Test VmPersistenceOneOf"""
