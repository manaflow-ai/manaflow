...
class TestSystemdUnitSpecPatch(unittest.TestCase):
    """SystemdUnitSpecPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemdUnitSpecPatch:
        """Test SystemdUnitSpecPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemdUnitSpecPatch`
        """
        model = SystemdUnitSpecPatch()
        if include_optional:
            return SystemdUnitSpecPatch(
                name = '',
                mode = 'oneshot',
                var_exec = [
                    ''
    ...
    def testSystemdUnitSpecPatch(self):
        """Test SystemdUnitSpecPatch"""
