...
from freestyle_client.api.execute_api import ExecuteApi
...
class TestExecuteApi(unittest.TestCase):
    ...
    def test_handle_execute_script(self) -> None:
        """Test case for handle_execute_script

        Execute Code
        """
        pass

    def test_handle_get_execute_run(self) -> None:
        """Test case for handle_get_execute_run

        Get information on execute run
        """
        pass

    def test_handle_list_execute_runs(self) -> None:
        """Test case for handle_list_execute_runs
