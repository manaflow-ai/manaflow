...
class TestGitTriggerAction(unittest.TestCase):
    """GitTriggerAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitTriggerAction:
        """Test GitTriggerAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitTriggerAction`
        """
        model = GitTriggerAction()
        if include_optional:
            return GitTriggerAction(
                endpoint = '',
                action = 'webhook'
            )
        else:
