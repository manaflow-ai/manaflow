...
class TestFreestyleDeployWebErrorResponse(unittest.TestCase):
    """FreestyleDeployWebErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleDeployWebErrorResponse:
        """Test FreestyleDeployWebErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleDeployWebErrorResponse`
        """
        model = FreestyleDeployWebErrorResponse()
        if include_optional:
            return FreestyleDeployWebErrorResponse(
                message = ''
            )
        else:
            return FreestyleDeployWebErrorResponse(
    ...
    def testFreestyleDeployWebErrorResponse(self):
        """Test FreestyleDeployWebErrorResponse"""
