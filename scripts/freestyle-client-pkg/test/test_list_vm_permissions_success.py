...
class TestListVmPermissionsSuccess(unittest.TestCase):
    """ListVmPermissionsSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListVmPermissionsSuccess:
        """Test ListVmPermissionsSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListVmPermissionsSuccess`
        """
        model = ListVmPermissionsSuccess()
        if include_optional:
            return ListVmPermissionsSuccess(
                permissions = [
                    freestyle_client.models.vm_permission.VmPermission(
                        id = '', 
                        vm_id = '', 
                        identity_id = '', 
                        allowed_users = [
    ...
    def testListVmPermissionsSuccess(self):
        """Test ListVmPermissionsSuccess"""
