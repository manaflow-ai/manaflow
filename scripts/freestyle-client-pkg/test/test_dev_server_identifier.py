...
class TestDevServerIdentifier(unittest.TestCase):
    """DevServerIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevServerIdentifier:
        """Test DevServerIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevServerIdentifier`
        """
        model = DevServerIdentifier()
        if include_optional:
            return DevServerIdentifier(
                repo_id = '',
                git_ref = ''
            )
        else:
    ...
    def testDevServerIdentifier(self):
        """Test DevServerIdentifier"""
