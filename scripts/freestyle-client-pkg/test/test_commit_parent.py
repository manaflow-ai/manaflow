...
class TestCommitParent(unittest.TestCase):
    """CommitParent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommitParent:
        """Test CommitParent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitParent`
        """
        model = CommitParent()
        if include_optional:
            return CommitParent(
