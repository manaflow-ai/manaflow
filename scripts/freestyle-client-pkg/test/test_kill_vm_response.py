...
class TestKillVmResponse(unittest.TestCase):
    """KillVmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KillVmResponse:
        """Test KillVmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KillVmResponse`
        """
        model = KillVmResponse()
        if include_optional:
            return KillVmResponse(
                id = ''
            )
        else:
            return KillVmResponse(
