...
class TestTerminalLogsResponse(unittest.TestCase):
    """TerminalLogsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerminalLogsResponse:
        """Test TerminalLogsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerminalLogsResponse`
        """
        model = TerminalLogsResponse()
        if include_optional:
            return TerminalLogsResponse(
                output = ''
            )
        else:
            return TerminalLogsResponse(
    ...
    def testTerminalLogsResponse(self):
        """Test TerminalLogsResponse"""
