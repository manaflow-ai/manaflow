...
class TestReadFileResponseContent(unittest.TestCase):
    """ReadFileResponseContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadFileResponseContent:
        """Test ReadFileResponseContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadFileResponseContent`
        """
        model = ReadFileResponseContent()
        if include_optional:
            return ReadFileResponseContent(
                content = '',
                kind = 'directory',
                files = [
                    ''
    ...
    def testReadFileResponseContent(self):
        """Test ReadFileResponseContent"""
