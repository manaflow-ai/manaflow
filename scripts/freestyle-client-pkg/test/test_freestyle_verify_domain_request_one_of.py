...
class TestFreestyleVerifyDomainRequestOneOf(unittest.TestCase):
    """FreestyleVerifyDomainRequestOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleVerifyDomainRequestOneOf:
        """Test FreestyleVerifyDomainRequestOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleVerifyDomainRequestOneOf`
        """
        model = FreestyleVerifyDomainRequestOneOf()
        if include_optional:
            return FreestyleVerifyDomainRequestOneOf(
    ...
    def testFreestyleVerifyDomainRequestOneOf(self):
        """Test FreestyleVerifyDomainRequestOneOf"""
