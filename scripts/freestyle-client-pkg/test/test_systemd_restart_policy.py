...
class TestSystemdRestartPolicy(unittest.TestCase):
    """SystemdRestartPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemdRestartPolicy:
        """Test SystemdRestartPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemdRestartPolicy`
        """
        model = SystemdRestartPolicy()
        if include_optional:
            return SystemdRestartPolicy(
                policy = 'no',
                restart_sec = 0,
                start_limit_burst = 0,
    ...
    def testSystemdRestartPolicy(self):
        """Test SystemdRestartPolicy"""
