...
class TestGitCommitPushRequest(unittest.TestCase):
    """GitCommitPushRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitCommitPushRequest:
        """Test GitCommitPushRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitCommitPushRequest`
        """
        model = GitCommitPushRequest()
        if include_optional:
            return GitCommitPushRequest(
    ...
    def testGitCommitPushRequest(self):
        """Test GitCommitPushRequest"""
