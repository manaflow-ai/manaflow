...
class TestListRepositoriesSuccess(unittest.TestCase):
    """ListRepositoriesSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRepositoriesSuccess:
        """Test ListRepositoriesSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRepositoriesSuccess`
        """
        model = ListRepositoriesSuccess()
        if include_optional:
            return ListRepositoriesSuccess(
                repositories = [
                    freestyle_client.models.repository_metadata.RepositoryMetadata(
                        branches = {
                            'key' : freestyle_client.models.branch_details.BranchDetails(
                                default = True, 
                                name = '', 
                                target = '', )
                            }, 
                        tags = {
                            'key' : freestyle_client.models.tag_details.TagDetails(
                                name = '', 
                                target = '', 
                                message = '', )
                            }, 
    ...
    def testListRepositoriesSuccess(self):
        """Test ListRepositoriesSuccess"""
