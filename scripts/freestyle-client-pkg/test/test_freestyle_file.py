...
class TestFreestyleFile(unittest.TestCase):
    """FreestyleFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleFile:
        """Test FreestyleFile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleFile`
        """
        model = FreestyleFile()
        if include_optional:
            return FreestyleFile(
                content = '',
                encoding = ''
            )
        else:
