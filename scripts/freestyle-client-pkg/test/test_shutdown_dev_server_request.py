...
class TestShutdownDevServerRequest(unittest.TestCase):
    """ShutdownDevServerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShutdownDevServerRequest:
        """Test ShutdownDevServerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShutdownDevServerRequest`
        """
        model = ShutdownDevServerRequest()
        if include_optional:
            return ShutdownDevServerRequest(
    ...
    def testShutdownDevServerRequest(self):
        """Test ShutdownDevServerRequest"""
