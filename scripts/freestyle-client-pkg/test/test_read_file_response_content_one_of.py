...
class TestReadFileResponseContentOneOf(unittest.TestCase):
    """ReadFileResponseContentOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadFileResponseContentOneOf:
        """Test ReadFileResponseContentOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadFileResponseContentOneOf`
        """
        model = ReadFileResponseContentOneOf()
        if include_optional:
            return ReadFileResponseContentOneOf(
                content = '',
                kind = 'file'
            )
        else:
    ...
    def testReadFileResponseContentOneOf(self):
        """Test ReadFileResponseContentOneOf"""
