...
class TestSuspendVmResponse(unittest.TestCase):
    """SuspendVmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuspendVmResponse:
        """Test SuspendVmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuspendVmResponse`
        """
        model = SuspendVmResponse()
        if include_optional:
            return SuspendVmResponse(
                id = ''
            )
        else:
            return SuspendVmResponse(
    ...
    def testSuspendVmResponse(self):
        """Test SuspendVmResponse"""
