...
class TestFreestyleGetLogsResponse(unittest.TestCase):
    """FreestyleGetLogsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleGetLogsResponse:
        """Test FreestyleGetLogsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleGetLogsResponse`
        """
        model = FreestyleGetLogsResponse()
        if include_optional:
            return FreestyleGetLogsResponse(
                logs = [
                    freestyle_client.models.freestyle_log_response_object.FreestyleLogResponseObject(
                        message = '', 
                        timestamp = '', )
                    ]
            )
    ...
    def testFreestyleGetLogsResponse(self):
        """Test FreestyleGetLogsResponse"""
