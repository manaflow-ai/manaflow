...
class TestExecuteLogEntry(unittest.TestCase):
    """ExecuteLogEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteLogEntry:
        """Test ExecuteLogEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteLogEntry`
        """
        model = ExecuteLogEntry()
        if include_optional:
            return ExecuteLogEntry(
                deployment = '',
                account_id = '',
