...
class TestGithubSyncConfigResponse(unittest.TestCase):
    """GithubSyncConfigResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GithubSyncConfigResponse:
        """Test GithubSyncConfigResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GithubSyncConfigResponse`
        """
        model = GithubSyncConfigResponse()
        if include_optional:
    ...
    def testGithubSyncConfigResponse(self):
        """Test GithubSyncConfigResponse"""
