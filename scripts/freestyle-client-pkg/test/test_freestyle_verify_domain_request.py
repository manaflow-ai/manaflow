...
class TestFreestyleVerifyDomainRequest(unittest.TestCase):
    """FreestyleVerifyDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleVerifyDomainRequest:
        """Test FreestyleVerifyDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleVerifyDomainRequest`
        """
        model = FreestyleVerifyDomainRequest()
        if include_optional:
            return FreestyleVerifyDomainRequest(
                domain = 'example.com',
    ...
    def testFreestyleVerifyDomainRequest(self):
        """Test FreestyleVerifyDomainRequest"""
