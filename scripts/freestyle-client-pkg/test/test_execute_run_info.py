...
class TestExecuteRunInfo(unittest.TestCase):
    """ExecuteRunInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteRunInfo:
        """Test ExecuteRunInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteRunInfo`
        """
        model = ExecuteRunInfo()
        if include_optional:
