...
class TestFreestyleNetworkPermission(unittest.TestCase):
    """FreestyleNetworkPermission unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleNetworkPermission:
        """Test FreestyleNetworkPermission
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleNetworkPermission`
        """
        model = FreestyleNetworkPermission()
        if include_optional:
            return FreestyleNetworkPermission(
                query = '',
                behavior = 'exact',
                action = 'deny'
            )
    ...
    def testFreestyleNetworkPermission(self):
        """Test FreestyleNetworkPermission"""
