...
class TestFreestyleCloudstateDeploySuccessResponse(unittest.TestCase):
    """FreestyleCloudstateDeploySuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleCloudstateDeploySuccessResponse:
        """Test FreestyleCloudstateDeploySuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleCloudstateDeploySuccessResponse`
        """
        model = FreestyleCloudstateDeploySuccessResponse()
        if include_optional:
            return FreestyleCloudstateDeploySuccessResponse(
                deployment_id = '',
    ...
    def testFreestyleCloudstateDeploySuccessResponse(self):
        """Test FreestyleCloudstateDeploySuccessResponse"""
