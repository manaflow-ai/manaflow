...
class TestHandleExecOnEphemeralDevServer200Response(unittest.TestCase):
    """HandleExecOnEphemeralDevServer200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleExecOnEphemeralDevServer200Response:
        """Test HandleExecOnEphemeralDevServer200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleExecOnEphemeralDevServer200Response`
        """
        model = HandleExecOnEphemeralDevServer200Response()
        if include_optional:
            return HandleExecOnEphemeralDevServer200Response(
                id = '',
                is_new = True,
                stdout = [
                    ''
    ...
    def testHandleExecOnEphemeralDevServer200Response(self):
        """Test HandleExecOnEphemeralDevServer200Response"""
