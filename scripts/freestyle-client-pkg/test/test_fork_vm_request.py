...
class TestForkVmRequest(unittest.TestCase):
    """ForkVmRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForkVmRequest:
        """Test ForkVmRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForkVmRequest`
        """
        model = ForkVmRequest()
        if include_optional:
            return ForkVmRequest(
                idle_timeout_seconds = 56,
                ports = [{port=443, targetPort=3000}],
                ready_signal_timeout_seconds = true,
