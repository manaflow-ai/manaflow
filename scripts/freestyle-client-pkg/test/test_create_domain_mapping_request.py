...
class TestCreateDomainMappingRequest(unittest.TestCase):
    """CreateDomainMappingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDomainMappingRequest:
        """Test CreateDomainMappingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDomainMappingRequest`
        """
        model = CreateDomainMappingRequest()
        if include_optional:
    ...
    def testCreateDomainMappingRequest(self):
        """Test CreateDomainMappingRequest"""
