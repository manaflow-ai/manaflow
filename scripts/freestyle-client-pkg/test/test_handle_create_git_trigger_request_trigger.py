...
class TestHandleCreateGitTriggerRequestTrigger(unittest.TestCase):
    """HandleCreateGitTriggerRequestTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleCreateGitTriggerRequestTrigger:
        """Test HandleCreateGitTriggerRequestTrigger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleCreateGitTriggerRequestTrigger`
        """
        model = HandleCreateGitTriggerRequestTrigger()
        if include_optional:
            return HandleCreateGitTriggerRequestTrigger(
                branches = [
                    ''
                    ],
                globs = [
    ...
    def testHandleCreateGitTriggerRequestTrigger(self):
        """Test HandleCreateGitTriggerRequestTrigger"""
