...
class TestFileSystemResponseOneOf1(unittest.TestCase):
    """FileSystemResponseOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileSystemResponseOneOf1:
        """Test FileSystemResponseOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileSystemResponseOneOf1`
        """
        model = FileSystemResponseOneOf1()
        if include_optional:
            return FileSystemResponseOneOf1(
                files = [
                    freestyle_client.models.file_info.FileInfo(
                        name = '', 
                        kind = '', )
                    ]
            )
    ...
    def testFileSystemResponseOneOf1(self):
        """Test FileSystemResponseOneOf1"""
