...
class TestTreeObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TreeObject:
        """Test TreeObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TreeObject`
        """
        model = TreeObject()
        if include_optional:
            return TreeObject(
