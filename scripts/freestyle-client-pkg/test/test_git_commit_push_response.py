...
class TestGitCommitPushResponse(unittest.TestCase):
    """GitCommitPushResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitCommitPushResponse:
        """Test GitCommitPushResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitCommitPushResponse`
        """
        model = GitCommitPushResponse()
        if include_optional:
    ...
    def testGitCommitPushResponse(self):
        """Test GitCommitPushResponse"""
