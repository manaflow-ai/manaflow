...
class TestCreateRecordParams(unittest.TestCase):
    """CreateRecordParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRecordParams:
        """Test CreateRecordParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRecordParams`
        """
        model = CreateRecordParams()
        if include_optional:
            return CreateRecordParams(
                domain = '',
                record = freestyle_client.models.dns_record_data.DnsRecordData(
                    kind = 'A', 
                    name = '', 
                    value = '', 
                    ttl = '', 
    ...
    def testCreateRecordParams(self):
        """Test CreateRecordParams"""
