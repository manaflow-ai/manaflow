...
class TestLinuxGroupSpec(unittest.TestCase):
    """LinuxGroupSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinuxGroupSpec:
        """Test LinuxGroupSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinuxGroupSpec`
        """
        model = LinuxGroupSpec()
        if include_optional:
            return LinuxGroupSpec(
                name = '',
                gid = 0,
                system = True
            )
