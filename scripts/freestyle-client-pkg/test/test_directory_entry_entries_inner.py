...
class TestDirectoryEntryEntriesInner(unittest.TestCase):
    """DirectoryEntryEntriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DirectoryEntryEntriesInner:
        """Test DirectoryEntryEntriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DirectoryEntryEntriesInner`
        """
        model = DirectoryEntryEntriesInner()
        if include_optional:
            return DirectoryEntryEntriesInner(
            )
        else:
            return DirectoryEntryEntriesInner(
        )
    ...
    def testDirectoryEntryEntriesInner(self):
        """Test DirectoryEntryEntriesInner"""
