...
class TestDevServerLogsRequest(unittest.TestCase):
    """DevServerLogsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DevServerLogsRequest:
        """Test DevServerLogsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DevServerLogsRequest`
        """
        model = DevServerLogsRequest()
        if include_optional:
            return DevServerLogsRequest(
    ...
    def testDevServerLogsRequest(self):
        """Test DevServerLogsRequest"""
