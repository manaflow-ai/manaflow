...
class TestCreateRepositoryResponseSuccess(unittest.TestCase):
    """CreateRepositoryResponseSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRepositoryResponseSuccess:
        """Test CreateRepositoryResponseSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRepositoryResponseSuccess`
        """
        model = CreateRepositoryResponseSuccess()
        if include_optional:
            return CreateRepositoryResponseSuccess(
                repo_id = ''
            )
        else:
            return CreateRepositoryResponseSuccess(
    ...
    def testCreateRepositoryResponseSuccess(self):
        """Test CreateRepositoryResponseSuccess"""
