...
class TestFreestyleIdentity(unittest.TestCase):
    """FreestyleIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleIdentity:
        """Test FreestyleIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleIdentity`
        """
        model = FreestyleIdentity()
        if include_optional:
            return FreestyleIdentity(
                id = '',
                managed = True
            )
        else:
    ...
    def testFreestyleIdentity(self):
        """Test FreestyleIdentity"""
