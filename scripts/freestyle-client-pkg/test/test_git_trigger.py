...
class TestGitTrigger(unittest.TestCase):
    """GitTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitTrigger:
        """Test GitTrigger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitTrigger`
        """
        model = GitTrigger()
        if include_optional:
            return GitTrigger(
