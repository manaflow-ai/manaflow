...
class TestSystemdRestartPolicyKind(unittest.TestCase):
    """SystemdRestartPolicyKind unit test stubs"""
    ...
    def testSystemdRestartPolicyKind(self):
        """Test SystemdRestartPolicyKind"""
        # inst = SystemdRestartPolicyKind()
