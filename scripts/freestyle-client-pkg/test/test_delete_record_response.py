...
class TestDeleteRecordResponse(unittest.TestCase):
    """DeleteRecordResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteRecordResponse:
        """Test DeleteRecordResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteRecordResponse`
        """
    ...
    def testDeleteRecordResponse(self):
        """Test DeleteRecordResponse"""
