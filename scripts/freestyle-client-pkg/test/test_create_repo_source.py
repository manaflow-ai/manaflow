...
class TestCreateRepoSource(unittest.TestCase):
    """CreateRepoSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRepoSource:
        """Test CreateRepoSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRepoSource`
        """
        model = CreateRepoSource()
        if include_optional:
            return CreateRepoSource(
                url = '',
                branch = '',
                depth = 56
            )
