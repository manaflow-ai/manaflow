...
class TestSetDefaultBranchRequest(unittest.TestCase):
    """SetDefaultBranchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetDefaultBranchRequest:
        """Test SetDefaultBranchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetDefaultBranchRequest`
        """
        model = SetDefaultBranchRequest()
        if include_optional:
            return SetDefaultBranchRequest(
                default_branch = ''
            )
        else:
            return SetDefaultBranchRequest(
    ...
    def testSetDefaultBranchRequest(self):
        """Test SetDefaultBranchRequest"""
