...
class TestVmMetricsInfo(unittest.TestCase):
    """VmMetricsInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VmMetricsInfo:
        """Test VmMetricsInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VmMetricsInfo`
        """
        model = VmMetricsInfo()
        if include_optional:
            return VmMetricsInfo(
                wall_time_seconds = 0,
                billing_day = '',
