...
from freestyle_client.api.dns_api import DNSApi
...
class TestDNSApi(unittest.TestCase):
    ...
    def test_handle_create_record(self) -> None:
        """Test case for handle_create_record

        Create DNS Record
        """
        pass

    def test_handle_delete_record(self) -> None:
        """Test case for handle_delete_record

        Delete DNS Record
        """
        pass

    def test_handle_list_records(self) -> None:
        """Test case for handle_list_records
