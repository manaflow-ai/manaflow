...
class TestFreestyleNetworkPermissionOneOf1(unittest.TestCase):
    """FreestyleNetworkPermissionOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreestyleNetworkPermissionOneOf1:
        """Test FreestyleNetworkPermissionOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreestyleNetworkPermissionOneOf1`
        """
        model = FreestyleNetworkPermissionOneOf1()
        if include_optional:
            return FreestyleNetworkPermissionOneOf1(
                query = '',
                behavior = 'exact',
                action = 'deny'
            )
    ...
    def testFreestyleNetworkPermissionOneOf1(self):
        """Test FreestyleNetworkPermissionOneOf1"""
