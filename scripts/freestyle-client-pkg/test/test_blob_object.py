...
class TestBlobObject(unittest.TestCase):
    """BlobObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlobObject:
        """Test BlobObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlobObject`
        """
        model = BlobObject()
        if include_optional:
            return BlobObject(
