...
class TestGitContents(unittest.TestCase):
    """GitContents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GitContents:
        """Test GitContents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitContents`
        """
        model = GitContents()
        if include_optional:
            return GitContents(
