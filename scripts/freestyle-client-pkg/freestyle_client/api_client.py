...
from freestyle_client.configuration import Configuration
from freestyle_client.api_response import ApiResponse, T as ApiResponseT
import freestyle_client.models
from freestyle_client import rest
from freestyle_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(freestyle_client.models, klass)
