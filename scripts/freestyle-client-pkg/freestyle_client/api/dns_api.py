...
class DNSApi:
    ...
    def handle_create_record(
        self,
        create_record_params: CreateRecordParams,
        ...
        :param create_record_params: (required)
        :type create_record_params: CreateRecordParams
        ...
        _param = self._handle_create_record_serialize(
            create_record_params=create_record_params,
    ...
    @validate_call
    def handle_create_record_with_http_info(
        self,
        create_record_params: CreateRecordParams,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def handle_create_record_without_preload_content(
        self,
        create_record_params: CreateRecordParams,
        _request_timeout: Union[
            None,
    ...
    def _handle_create_record_serialize(
        self,
        ...
        if create_record_params is not None:
            _body_params = create_record_params
    ...
    def handle_delete_record(
        ...
        _param = self._handle_delete_record_serialize(
            domain=domain,
            record=record,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def handle_delete_record_with_http_info(
        self,
        domain: StrictStr,
        record: DnsRecord,
        _request_timeout: Union[
    ...
    @validate_call
    def handle_delete_record_without_preload_content(
        self,
        domain: StrictStr,
        record: DnsRecord,
        _request_timeout: Union[
    ...
    def _handle_delete_record_serialize(
        self,
        domain,
        record,
        _request_auth,
    ...
    def handle_list_records(
        ...
        _param = self._handle_list_records_serialize(
            domain=domain,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def handle_list_records_with_http_info(
        self,
        domain: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def handle_list_records_without_preload_content(
        self,
        domain: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _handle_list_records_serialize(
        self,
        domain,
        _request_auth,
        _content_type,
