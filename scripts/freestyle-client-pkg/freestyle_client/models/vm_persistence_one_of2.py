...
class VmPersistenceOneOf2(BaseModel):
    """
    VmPersistenceOneOf2
    """ # noqa: E501
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['persistent']):
            raise ValueError("must be one of enum values ('persistent')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VmPersistenceOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VmPersistenceOneOf2 from a dict"""
        if obj is None:
            return None
