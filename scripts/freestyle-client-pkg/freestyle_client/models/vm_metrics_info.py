...
class VmMetricsInfo(BaseModel):
    """
    VmMetricsInfo
    """ # noqa: E501
    wall_time_seconds: Annotated[int, Field(strict=True, ge=0)] = Field(alias="wallTimeSeconds")
    billing_day: StrictStr = Field(alias="billingDay")
    is_active_today: StrictBool = Field(alias="isActiveToday")
    __properties: ClassVar[List[str]] = ["wallTimeSeconds", "billingDay", "isActiveToday"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wallTimeSeconds": obj.get("wallTimeSeconds"),
            "billingDay": obj.get("billingDay"),
            "isActiveToday": obj.get("isActiveToday")
        })
        return _obj
