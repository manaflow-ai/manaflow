...
class HandleEphemeralDevServer200Response(BaseModel):
    ...
    vm_id: Optional[StrictStr] = Field(default=None, alias="vmId")
    base_id: Optional[StrictStr] = Field(default=None, alias="baseId")
    __properties: ClassVar[List[str]] = ["url", "isNew", "devCommandRunning", "installCommandRunning", "mcpEphemeralUrl", "ephemeralUrl", "vmId", "baseId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if vm_id (nullable) is None
        # and model_fields_set contains the field
        if self.vm_id is None and "vm_id" in self.model_fields_set:
            _dict['vmId'] = None
