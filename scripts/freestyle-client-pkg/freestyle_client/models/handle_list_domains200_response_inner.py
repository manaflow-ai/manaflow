...
class HandleListDomains200ResponseInner(BaseModel):
    ...
    id: UUID
    verified_dns: StrictBool = Field(alias="verifiedDns")
    implicitly_owned: StrictBool = Field(alias="implicitlyOwned")
    deploy_to_domain: StrictBool = Field(alias="deployToDomain")
    manage_dns: StrictBool = Field(alias="manageDns")
    deploy_to_subdomains: StrictBool = Field(alias="deployToSubdomains")
    __properties: ClassVar[List[str]] = ["domain", "accountId", "createdAt", "id", "verifiedDns", "implicitlyOwned", "deployToDomain", "manageDns", "deployToSubdomains"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "verifiedDns": obj.get("verifiedDns"),
            "implicitlyOwned": obj.get("implicitlyOwned"),
            "deployToDomain": obj.get("deployToDomain"),
            "manageDns": obj.get("manageDns"),
            "deployToSubdomains": obj.get("deployToSubdomains")
        })
        return _obj
