...
class WaitVmResponse(BaseModel):
    """
    WaitVmResponse
    """ # noqa: E501
    id: StrictStr = Field(description="Short VM ID (5-character alphanumeric) - used for filesystem operations")
    exit_status: StrictStr = Field(alias="exitStatus")
    __properties: ClassVar[List[str]] = ["id", "exitStatus"]
