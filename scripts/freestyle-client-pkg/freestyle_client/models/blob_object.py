...
class BlobObject(BaseModel):
    ...
    Blob object
    """ # noqa: E501
    content: StrictStr = Field(description="The content of the blob, base64 encoded.")
    encoding: BlobEncoding = Field(description="The encoding of the blob. Always `base64`.")
    sha: StrictStr = Field(description="The object's hash.")
    size: Annotated[int, Field(strict=True, ge=0)] = Field(description="The blob's size in bytes")
    __properties: ClassVar[List[str]] = ["content", "encoding", "sha", "size"]
