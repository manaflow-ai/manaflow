...
class FreestyleDeployWebSuccessResponseV2OneOf(BaseModel):
    """
    ...
    entrypoint: StrictStr = Field(description="The entrypoint file for the website. If not specified we try to automatically detect it.")
    __properties: ClassVar[List[str]] = ["deploymentId", "projectId", "domains", "entrypoint"]
