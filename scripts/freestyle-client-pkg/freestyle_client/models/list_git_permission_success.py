...
class ListGitPermissionSuccess(BaseModel):
    """
    ListGitPermissionSuccess
    """ # noqa: E501
    repositories: List[AccessibleRepository]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repositories": [AccessibleRepository.from_dict(_item) for _item in obj["repositories"]] if obj.get("repositories") is not None else None
        })
        return _obj
