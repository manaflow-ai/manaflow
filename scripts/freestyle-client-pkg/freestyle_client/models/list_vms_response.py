...
class ListVmsResponse(BaseModel):
    ...
    running_count: Annotated[int, Field(strict=True, ge=0)] = Field(alias="runningCount")
    starting_count: Annotated[int, Field(strict=True, ge=0)] = Field(alias="startingCount")
    stopped_count: Annotated[int, Field(strict=True, ge=0)] = Field(alias="stoppedCount")
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    __properties: ClassVar[List[str]] = ["vms", "totalCount", "runningCount", "startingCount", "stoppedCount", "userId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vms": [VmInfo.from_dict(_item) for _item in obj["vms"]] if obj.get("vms") is not None else None,
            "totalCount": obj.get("totalCount"),
            "runningCount": obj.get("runningCount"),
            "startingCount": obj.get("startingCount"),
            "stoppedCount": obj.get("stoppedCount"),
