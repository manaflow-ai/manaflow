...
class CustomBuildOptions(BaseModel):
    """
    CustomBuildOptions
    """ # noqa: E501
    command: StrictStr
    out_dir: Optional[StrictStr] = Field(default=None, alias="outDir")
    env_vars: Optional[Dict[str, StrictStr]] = Field(default=None, alias="envVars")
    __properties: ClassVar[List[str]] = ["command", "outDir", "envVars"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if out_dir (nullable) is None
        # and model_fields_set contains the field
        if self.out_dir is None and "out_dir" in self.model_fields_set:
            _dict['outDir'] = None
