...
class ExecAwaitRequest(BaseModel):
    """
    ExecAwaitRequest
    """ # noqa: E501
    command: StrictStr
    terminal: Optional[StrictStr] = None
    timeout_ms: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="timeoutMs")
    __properties: ClassVar[List[str]] = ["command", "terminal", "timeoutMs"]
