...
class VmPersistenceOneOf1(BaseModel):
    """
    The VM will be deleted after the idle timeout. It's not guaranteed that the VM will be deleted immediately.
    """ # noqa: E501
    delete_event: Optional[VmDeleteEvent] = Field(default=None, alias="deleteEvent")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["deleteEvent", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if delete_event (nullable) is None
        # and model_fields_set contains the field
        if self.delete_event is None and "delete_event" in self.model_fields_set:
            _dict['deleteEvent'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deleteEvent": obj.get("deleteEvent"),
            "type": obj.get("type")
        })
        return _obj
