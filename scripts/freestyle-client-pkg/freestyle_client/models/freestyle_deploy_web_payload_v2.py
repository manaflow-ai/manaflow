...
class FreestyleDeployWebPayloadV2(BaseModel):
    """
    FreestyleDeployWebPayloadV2
    """ # noqa: E501
    source: DeploymentSource
    config: FreestyleDeployWebConfiguration
    __properties: ClassVar[List[str]] = ["source", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "source": DeploymentSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
