...
class StartedVmResponse(BaseModel):
    """
    StartedVmResponse
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "domains", "console_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if console_url (nullable) is None
        # and model_fields_set contains the field
        if self.console_url is None and "console_url" in self.model_fields_set:
            _dict['console_url'] = None
