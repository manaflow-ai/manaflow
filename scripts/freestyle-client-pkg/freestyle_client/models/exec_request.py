...
class ExecRequest(BaseModel):
    ...
    ExecRequest
    """ # noqa: E501
    dev_server: DevServerIdentifier = Field(alias="devServer")
    command: StrictStr
    background: StrictBool = Field(description="Spawn this command as a background process and return immediately")
    __properties: ClassVar[List[str]] = ["devServer", "command", "background"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dev_server
        if self.dev_server:
            _dict['devServer'] = self.dev_server.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devServer": DevServerIdentifier.from_dict(obj["devServer"]) if obj.get("devServer") is not None else None,
