...
class FreestyleCloudstateDeployRequest(BaseModel):
    """
    FreestyleCloudstateDeployRequest
    """ # noqa: E501
    classes: StrictStr
    config: Optional[FreestyleCloudstateDeployConfiguration] = None
    __properties: ClassVar[List[str]] = ["classes", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": FreestyleCloudstateDeployConfiguration.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
