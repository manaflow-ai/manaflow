...
class HandleCreateGitTriggerRequestTrigger(BaseModel):
    """
    HandleCreateGitTriggerRequestTrigger
    """ # noqa: E501
    branches: Optional[List[StrictStr]] = None
    globs: Optional[List[StrictStr]] = None
    event: StrictStr
    __properties: ClassVar[List[str]] = ["branches", "globs", "event"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if globs (nullable) is None
        # and model_fields_set contains the field
        if self.globs is None and "globs" in self.model_fields_set:
            _dict['globs'] = None
