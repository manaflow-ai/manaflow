...
class FreestyleCloudstateDeploySuccessResponse(BaseModel):
    """
    FreestyleCloudstateDeploySuccessResponse
    """ # noqa: E501
    deployment_id: UUID = Field(alias="deploymentId")
    cloudstate_database_id: UUID = Field(alias="cloudstateDatabaseId")
    __properties: ClassVar[List[str]] = ["deploymentId", "cloudstateDatabaseId"]
