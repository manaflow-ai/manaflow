...
class Files(BaseModel):
    ...
    Files
    """ # noqa: E501
    files: Dict[str, StrictStr] = Field(description="A map of file names to their contents.")
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["files", "commitMessage", "authorName", "authorEmail", "type"]
