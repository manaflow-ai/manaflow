...
class DevServerConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["devCommand", "installCommand", "timeout", "envVars", "ports", "preset", "systemd", "users", "groups", "additionalFiles", "webTerminal", "webVscode", "additionalRepositories"]
