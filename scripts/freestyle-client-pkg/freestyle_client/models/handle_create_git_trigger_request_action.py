...
class HandleCreateGitTriggerRequestAction(BaseModel):
    ...
    endpoint: StrictStr
    action: StrictStr
    __properties: ClassVar[List[str]] = ["endpoint", "action"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleCreateGitTriggerRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleCreateGitTriggerRequestAction from a dict"""
        if obj is None:
            return None
