...
class ListRepositoriesSuccess(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repositories": [RepositoryMetadata.from_dict(_item) for _item in obj["repositories"]] if obj.get("repositories") is not None else None,
            "total": obj.get("total"),
