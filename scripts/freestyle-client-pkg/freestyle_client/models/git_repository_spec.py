...
class GitRepositorySpec(BaseModel):
    ...
    GitRepositorySpec
    """ # noqa: E501
    repo: StrictStr = Field(description="url or id of the git repository")
    path: StrictStr = Field(description="path to place the repo on")
    rev: Optional[StrictStr] = Field(default=None, description="optional rev (branch, tag, commit)")
    __properties: ClassVar[List[str]] = ["repo", "path", "rev"]
