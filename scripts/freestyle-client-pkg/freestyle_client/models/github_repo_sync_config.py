...
class GithubRepoSyncConfig(BaseModel):
    """
    GithubRepoSyncConfig
    """ # noqa: E501
    freestyle_repo_id: UUID = Field(alias="freestyleRepoId")
    account_id: UUID = Field(alias="accountId")
    installation_id: StrictInt = Field(alias="installationId")
    github_repo_id: StrictInt = Field(alias="githubRepoId")
    github_repo_name: StrictStr = Field(alias="githubRepoName")
    created_at: datetime = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["freestyleRepoId", "accountId", "installationId", "githubRepoId", "githubRepoName", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "freestyleRepoId": obj.get("freestyleRepoId"),
            "accountId": obj.get("accountId"),
            "installationId": obj.get("installationId"),
            "githubRepoId": obj.get("githubRepoId"),
            "githubRepoName": obj.get("githubRepoName"),
