...
class BranchInfo(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    commit: Optional[StrictStr] = Field(default=None, description="The latest commit ID on this branch. Null if the branch is empty.")
    __properties: ClassVar[List[str]] = ["name", "commit"]
