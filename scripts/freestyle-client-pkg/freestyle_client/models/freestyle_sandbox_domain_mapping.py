...
class FreestyleSandboxDomainMapping(BaseModel):
    """
    ...
    ownership_id: UUID = Field(alias="ownershipId")
    created_at: datetime = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "domain", "deploymentId", "ownershipId", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ownershipId": obj.get("ownershipId"),
