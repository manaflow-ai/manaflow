...
class HandleGetExecuteRun200Response(BaseModel):
    """
    HandleGetExecuteRun200Response
    """ # noqa: E501
    metadata: ExecuteLogEntry
    code: Optional[ExecuteRunInfo] = None
    __properties: ClassVar[List[str]] = ["metadata", "code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": ExecuteLogEntry.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "code": ExecuteRunInfo.from_dict(obj["code"]) if obj.get("code") is not None else None
        })
        return _obj
