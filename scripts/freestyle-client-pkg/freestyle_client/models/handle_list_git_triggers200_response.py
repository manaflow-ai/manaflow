...
class HandleListGitTriggers200Response(BaseModel):
    """
    HandleListGitTriggers200Response
    """ # noqa: E501
    triggers: List[GitRepositoryTrigger]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "triggers": [GitRepositoryTrigger.from_dict(_item) for _item in obj["triggers"]] if obj.get("triggers") is not None else None
        })
        return _obj
