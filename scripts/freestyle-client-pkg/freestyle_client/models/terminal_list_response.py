...
class TerminalListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["terminals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "terminals": [TerminalSession.from_dict(_item) for _item in obj["terminals"]] if obj.get("terminals") is not None else None
        })
        return _obj
