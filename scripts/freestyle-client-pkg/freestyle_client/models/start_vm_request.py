...
class StartVmRequest(BaseModel):
    ...
    ready_signal_timeout_seconds: Optional[StrictInt] = Field(default=None, alias="readySignalTimeoutSeconds")
    wait_for_ready_signal: Optional[StrictBool] = Field(default=None, alias="waitForReadySignal")
    __properties: ClassVar[List[str]] = ["idleTimeoutSeconds", "readySignalTimeoutSeconds", "waitForReadySignal"]
