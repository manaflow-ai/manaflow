...
class FreestyleGetLogsResponse(BaseModel):
    """
    FreestyleGetLogsResponse
    """ # noqa: E501
    logs: List[FreestyleLogResponseObject]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [FreestyleLogResponseObject.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
