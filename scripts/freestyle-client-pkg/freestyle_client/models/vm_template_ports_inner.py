...
class VmTemplatePortsInner(BaseModel):
    """
    VmTemplatePortsInner
    """ # noqa: E501
    port: Annotated[int, Field(strict=True, ge=0)]
    target_port: Annotated[int, Field(strict=True, ge=0)] = Field(alias="targetPort")
    __properties: ClassVar[List[str]] = ["port", "targetPort"]
