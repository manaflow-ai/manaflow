...
class TreeObject(BaseModel):
    ...
    Tree object
    """ # noqa: E501
    tree: List[TreeEntry] = Field(description="The tree's entries")
    sha: StrictStr = Field(description="The tree's hash ID")
    __properties: ClassVar[List[str]] = ["tree", "sha"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tree": [TreeEntry.from_dict(_item) for _item in obj["tree"]] if obj.get("tree") is not None else None,
            "sha": obj.get("sha")
        })
        return _obj
