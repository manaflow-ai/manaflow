...
class DirectoryEntry(BaseModel):
    ...
    name: StrictStr
    path: StrictStr
    sha: StrictStr = Field(description="The hash / object ID of the directory.")
    entries: List[DirectoryEntryEntriesInner]
    type: StrictStr
    __properties: ClassVar[List[str]] = ["name", "path", "sha", "entries", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": obj.get("path"),
            "sha": obj.get("sha"),
            "entries": [DirectoryEntryEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "type": obj.get("type")
        })
        return _obj
