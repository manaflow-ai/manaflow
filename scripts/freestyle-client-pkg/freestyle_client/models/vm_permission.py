...
class VmPermission(BaseModel):
    """
    Full VM permission record
    """ # noqa: E501
    id: UUID
    vm_id: StrictStr = Field(alias="vmId")
    identity_id: UUID = Field(alias="identityId")
    allowed_users: Optional[List[StrictStr]] = Field(default=None, alias="allowedUsers")
    granted_at: datetime = Field(alias="grantedAt")
    granted_by: UUID = Field(alias="grantedBy")
    __properties: ClassVar[List[str]] = ["id", "vmId", "identityId", "allowedUsers", "grantedAt", "grantedBy"]
