...
class FreestyleExecuteScriptParams(BaseModel):
    """
    FreestyleExecuteScriptParams
    """ # noqa: E501
    script: StrictStr = Field(description="The JavaScript or TypeScript script to execute")
    config: Optional[FreestyleExecuteScriptParamsConfiguration] = None
    __properties: ClassVar[List[str]] = ["script", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": FreestyleExecuteScriptParamsConfiguration.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
