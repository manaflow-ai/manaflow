...
class ListIdentitiesSuccess(BaseModel):
    """
    ListIdentitiesSuccess
    """ # noqa: E501
    identities: List[FreestyleIdentity]
    offset: Annotated[int, Field(strict=True, ge=0)]
    total: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["identities", "offset", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identities": [FreestyleIdentity.from_dict(_item) for _item in obj["identities"]] if obj.get("identities") is not None else None,
