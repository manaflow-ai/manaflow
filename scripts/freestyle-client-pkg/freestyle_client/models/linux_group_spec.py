...
class LinuxGroupSpec(BaseModel):
    """
    LinuxGroupSpec
    """ # noqa: E501
    name: StrictStr = Field(description="Unique group name")
    gid: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Optional fixed GID; if None, allocate")
    system: Optional[StrictBool] = Field(default=False, description="System group (allocator uses system range)")
    __properties: ClassVar[List[str]] = ["name", "gid", "system"]
