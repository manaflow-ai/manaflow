...
class UpdateAllowedUsersRequestBody(BaseModel):
    """
    UpdateAllowedUsersRequestBody
    """ # noqa: E501
    allowed_users: Optional[List[StrictStr]] = Field(default=None, description="List of allowed Linux users. If null, identity can SSH as any user. If specified, identity can only SSH as users in this list.", alias="allowedUsers")
    __properties: ClassVar[List[str]] = ["allowedUsers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if allowed_users (nullable) is None
        # and model_fields_set contains the field
        if self.allowed_users is None and "allowed_users" in self.model_fields_set:
            _dict['allowedUsers'] = None
