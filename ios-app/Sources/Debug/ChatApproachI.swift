...
/// Approach I: Container Resize
/// - Uses contentInsetAdjustmentBehavior = .never to prevent iOS from auto-adding safe area insets
/// - Manually manages contentInset.bottom to account for input bar + safe area
/// - Keyboard animation matches Apple's curve via UIViewPropertyAnimator
...
final class ContainerResizeViewController: UIViewController {
    ...
    private func setupScrollView() {
        ...
        // Key fix: prevent iOS from auto-adding safe area insets
